# Field Primer — AmmoOS 2.0.0-beta5 stack companion
...
Field technology doctrine — architecture in AmmoOS manual
...
Component repo: [Field_Primer](https://github.com/ZacharyGeurts/Field_Primer) · Pages hub redirects to the AmmoOS manual.
