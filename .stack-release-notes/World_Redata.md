# World Redata — AmmoOS 2.0.0-beta5 stack companion
...
WRDT1 envelopes — architecture in AmmoOS manual
...
Component repo: [World_Redata](https://github.com/ZacharyGeurts/World_Redata) · Pages hub redirects to the AmmoOS manual.
