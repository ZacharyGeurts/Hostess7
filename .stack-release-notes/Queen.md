# Queen Browser — AmmoOS 2.0.0-beta5 stack companion
...
Secured shell on :9481 — documentation in AmmoOS manual
...
Component repo: [Queen](https://github.com/ZacharyGeurts/Queen) · Pages hub redirects to the AmmoOS manual.
