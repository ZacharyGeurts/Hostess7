# AMOURANTHRTX — AmmoOS 2.0.0-beta4 stack companion
...
Field Die display — architecture in AmmoOS manual
...
Component repo: [AMOURANTHRTX](https://github.com/ZacharyGeurts/AMOURANTHRTX) · Pages hub redirects to the AmmoOS manual.
