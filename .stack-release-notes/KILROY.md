# KILROY — AmmoOS 2.0.0-beta6 stack companion
...
Online test environment — browser GUI + source tree from GitHub
...
Component repo: [KILROY](https://github.com/ZacharyGeurts/KILROY) · Pages hub redirects to the AmmoOS manual.
