# Final Ear — AmmoOS 2.0.0-beta5 stack companion
...
Audio truth filters — launch surfaces in AmmoOS manual
...
Component repo: [Final_Ear](https://github.com/ZacharyGeurts/Final_Ear) · Pages hub redirects to the AmmoOS manual.
