...
(function () {
  ...
  const LANES = [
    { id: "training", title: "Training Viewer", hint: "Connected models graph · chambers", url: "/Hostess7/bookmark-jump/?id=h7-training-viewer", api: null },
    { id: "brain", title: "Hostess Brain", hint: "Super intelligence · AI communique", url: "queen://hostess", api: "/api/field-brain" },
    { id: "guardian", title: "Neural Guardian", hint: "Truth · lie · deception discern", url: "/Hostess7/command#training", api: "/api/hostess7/training" },
    ...
    { id: "growth", title: "Mastery & Growth", hint: "Facets · teach · assess", url: "/Hostess7/command#training", api: "/api/hostess7/training" },
  ];

  const SENSE = [
    { id: "eye", title: "Final_Eye · Vision NN", hint: "OCR · offense · encourage gate", url: "queen://eyeball", api: "/api/queen-eyeball" },
    { id: "ear", title: "Final Ear · Audio NN", hint: "Auditus · signal intel · GAC1", url: "/Hostess7/queen/queen-final-ear-manager.html", api: "/api/queen-earball" },
    { id: "mouth", title: "Final Mouth · Voice NN", hint: "Loquor · GVC1 · thought-voice callosum", url: "/Hostess7/queen/queen-final-mouth-manager.html", api: "/api/queen-mouthball" },
    { id: "wire", title: "Invincible Wire", hint: "Eye ↔ Ear ↔ Mouth quorum", url: "/Hostess7/api/sense-neural-wire", api: "/api/sense-neural-wire" },
