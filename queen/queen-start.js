  ...
  const FOLDERS = [
    {
      ...
      programs: [
        { id: "browser", label: "Queen Browser", hint: "Tabbed OS", url: "/Hostess7/queen/browser.html" },
        { id: "os-desktop", label: "Queen Desktop", hint: "Taskbar shell", url: "/Hostess7/queen/queen-desktop.html" },
        { id: "files", label: "Files", hint: "Folder manager", url: "/Hostess7/queen/queen-files.html" },
        { id: "terminal", label: "Terminal", hint: "GNU shell", url: "queen://terminal" },
        { id: "thermal-manager", label: "Thermal Manager", hint: "Landauer guard", url: "/Hostess7/queen/queen-thermal-manager.html" },
        { id: "code", label: "Queen Code", hint: "Editor", url: "/Hostess7/queen/queen-code.html" },
    ...
    },
    {
      ...
      programs: [
        { id: "ammoos", label: "NEXUS Field", hint: "C2 desktop", url: "/Hostess7/field" },
        { id: "field-command", label: "Field Command", hint: "Operator deck", url: "/Hostess7/command" },
        { id: "nexus-c2", label: "AmmoOS C2", hint: "Panel grid", url: "/Hostess7/queen/queen-nexus-c2.html" },
        ...
        { id: "field", label: "Field Tech", hint: "Primer dock", url: "/Hostess7/queen/?embed=1&dock=field" },
      ],
    },
    {
      id: "hostess-7",
      ...
      programs: [
        { id: "hostess-hub", label: "AI Training Hub", hint: "Every AI lane", url: "/Hostess7/queen/queen-hostess7-hub.html" },
        { id: "hostess", label: "Hostess Brain", hint: "Super intelligence", url: "queen://hostess" },
        { id: "hostess-training", label: "Training Viewer", hint: "Connected models", url: "/Hostess7/bookmark-jump/?id=h7-training-viewer" },
        { id: "eyeball", label: "Final_Eye", hint: "Vision NN", url: "queen://eyeball" },
        { id: "final-ear-manager", label: "Final Ear", hint: "Audio NN", url: "/Hostess7/queen/queen-final-ear-manager.html" },
