...
(function () {
  ...
  function resolveUrl(raw) {
    ...
    if (s.startsWith("queen://")) {
      ...
      if (path === "final-mouth" || path === "final-mouth-manager" || path === "mouthball") return "/Hostess7/queen/queen-final-mouth-manager.html";
      if (path === "hostess7-hub" || path === "hostess7" || path === "hostess" || path === "ai-training") return "/Hostess7/queen/queen-hostess7-hub.html";
      if (path === "command" || path === "field-command") return "/Hostess7/command";
      if (path === "os" || path === "start" || path === "desktop") return "/Hostess7/queen/queen-start.html";
