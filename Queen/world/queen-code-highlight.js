/**
 * Queen Code highlight — lightweight tokenizer (no Monaco, no telemetry).
 * g16 discern + web/config/data grammars · rich token classes via queen-syntax.css
 */
(function (global) {
  "use strict";
