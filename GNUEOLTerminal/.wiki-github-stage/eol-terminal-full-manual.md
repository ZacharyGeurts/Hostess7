...
See [Widgets & tight paneling](widgets-and-paneling):
...
See [Entropy grade production](entropy-grade) and [Sovereign time](sovereign-time).
...
See [RTX panels](rtx-panels).

## 12. Classic Schooler wiki map

- Overview — [GNU Technical Manual](gnu-technical-manual)
- Emacs — [emacs](emacs)
- Bash — [bash](bash)
- Coreutils — [coreutils](coreutils)
- SSH — [ssh](ssh)
- GPL — [gpl](gpl)
- Field Tech — [field-tech](field-tech)

## 13. Field Technology primer (22 chapters)

Full primer from `Textbook/field-technology-v5.txt`:

1. [Ch 01 · Read this before you dispatch anything](ft-ch01-read-this-before-you-dispatch-anything)
2. [Ch 02 · Learning objectives](ft-ch02-learning-objectives)
3. [Ch 03 · Learning objectives](ft-ch03-learning-objectives)
4. [Ch 04 · Learning objectives](ft-ch04-learning-objectives)
5. [Ch 05 · Learning objectives](ft-ch05-learning-objectives)
6. [Ch 06 · Learning objectives](ft-ch06-learning-objectives)
7. [Ch 07 · Offensive Dispatch — GPU Field Engine](ft-ch07-offensive-dispatch-gpu-field-engine)
8. [Ch 08 · Die-Resident Universe](ft-ch08-die-resident-universe-field-die-data-bus)
9. [Ch 09 · Stability Under Load — FCC & Tesla](ft-ch09-stability-under-load-fcc-tesla)
10. [Ch 10 · Hardware Spiderweb](ft-ch10-hardware-spiderweb-sub-micron-mirror)
11. [Ch 11 · Observability](ft-ch11-observability-reading-the-battlefield)
12. [Ch 12 · Reality vs Theory — The Rocks](ft-ch12-reality-vs-theory-the-rocks)
13. [Ch 13 · Thermodynamic receipts](ft-ch13-creditor-deep-dive-thermodynamic-receipts)
14. [Ch 14 · Shannon Oracle](ft-ch14-creditor-deep-dive-shannon-oracle)
15. [Ch 15 · Maxwell GPU](ft-ch15-creditor-deep-dive-maxwell-gpu)
16. [Ch 16 · Love Coupling](ft-ch16-sacred-long-form-love-coupling)
17. [Ch 17 · God Boundary](ft-ch17-sacred-long-form-god-boundary)
18. [Ch 18 · Operator Covenant](ft-ch18-sacred-long-form-operator-covenant)
19. [Ch 19 · Sovereign time](ft-ch19-introduction-why-sovereign-time-exists)
20. [Ch 20 · Terror-threat posture](ft-ch20-introduction-public-services-under-terror-threat-posture)
21. [Ch 21 · Queen doctrine](ft-ch21-introduction-queen-doctrine)
22. [Ch 22 · Glossary v5](ft-ch22-glossary-field-technology-v5)
