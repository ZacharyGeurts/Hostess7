...
TOOL_ENTRIES: tuple[dict[str, object], ...] = (
    ...
    {"id": "field_one_rollout", "category": "storage", "title": "field-one-rollout.py",
     "path": "NewLatest/lib/field-one-rollout.py", "cmd": "./Hostess7.sh field-rollout-test",
     "summary": "Test secure Field 1 stack · rollout 10 racks · double worldwide",
     "tags": ("field", "field1", "rollout", "worldwide", "security", "qemu")},
    {"id": "field_one_absorb", "category": "storage", "title": "field-one absorb",
     "path": "NewLatest/lib/field-one.py", "cmd": "./Hostess7.sh field-absorb",
     "summary": "Universal ingress — everything to Field 1, even outside network",
     "tags": ("field", "field1", "absorb", "ingress", "wan")},
