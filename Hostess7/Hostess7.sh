...
"
        ...
        newcomer-sphere|sphere-destroy|no-machine-again|sphere-melt|volts-sphere)
            ...
            ;;
        no-detached-fields|no-detach|field-one-no-gaps|earth-stabilize|stabilize-earth|big-grin-kicks)
            shift
        ...
        eternal-plane|field-one-eternal|eternal|nobody-plays-fields|lanes-always-clean)
            ...
            ;;
        full-weave|weave|field-weave|fabric-weave)
            shift
        ...
        trillions|kill-path|stands-in-way|kill-whoever)
            ...
            ;;
        intergalactic|xyz|xyz-beyond|beyond)
            shift
