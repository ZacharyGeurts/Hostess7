...
(function () {
  ...
  const JUMPS = {
    ...
    "cmd-field": { title: "NEXUS Field", ensure: "/api/health", target: "/Hostess7/field", httpsSecure: true },
    "cmd-deck": { title: "Field Command", ensure: "/api/health", target: "/Hostess7/command", httpsSecure: true },
    "cmd-c2": {
      title: "NEXUS C2",
      ensure: "/api/health",
      target: "/Hostess7/queen/queen-nexus-c2.html",
      queenWrap: true,
      httpsSecure: true,
    },
    "g16-compiler": {
    ...
    "h7-g16-online": {
      ...
      target: "/Hostess7/g16-build-output",
      pagesFallback: "/g16-build-output/",
      httpsSecure: true,
    },
    "ammonet": {
  ...
  function queenLaunch(url) {
    const q = "/Hostess7/queen/browser.html?launch=" + encodeURIComponent(url);
