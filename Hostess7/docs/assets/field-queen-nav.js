...
(function (global) {
  ...
  function secureUrl(url, opts) {
    ...
    if (pagesRuntime() && isHostBrowser()) {
      if (u.includes(":9481") || u.includes("/Hostess7/queen/")) {
    ...
    if (!pagesRuntime()) {
      ...
      if (u.includes(":9481") && !u.includes("browser.html")) {
        return "http://127.0.0.1:" + QUEEN_PORT + "/Hostess7/queen/browser.html?launch=" + encodeURIComponent(u);
      }
    }
    return u;
  }
  ...
  function queenBrowserBase() {
    if (global.H7_QUEEN_LOOPBACK && (global.H7_QUEEN_LOOPBACK.world_ok || global.H7_QUEEN_LOOPBACK.queen)) {
      return global.H7_QUEEN_LOOPBACK.shell || ("http://127.0.0.1:" + QUEEN_PORT + "/Hostess7/queen/browser.html");
    }
    if (pagesRuntime()) {
