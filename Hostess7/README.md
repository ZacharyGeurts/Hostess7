# Hostess 7 2.0.8 — KILROY Field Brain (Main Project)

**Version:** `2.0.8` · **Release:** [RELEASE-2.0.8.md](RELEASE-2.0.8.md) · **Roadmap:** [docs/ROADMAP-3.0.md](docs/ROADMAP-3.0.md)  
...
./Hostess7.sh publish-source       # 2.0.8 → main + gh-pages (H7 optimise baked in)
```
