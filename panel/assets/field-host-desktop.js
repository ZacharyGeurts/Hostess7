...
(function () {
  ...
  function desktopDefaultFallback() {
    ...
    const rows = [
      ...
      { id: "queen-gameroom", name: "Queen Room", hint: "Movies · CHIPS emulators · arcade", icon: "queen-prog-gameroom", exec: world + "/queen-game-room.html", icon_url: assets + "/queen-prog-gameroom.png", pinned: true, shell: true, category: "NEXUS · Queen Browser" },
