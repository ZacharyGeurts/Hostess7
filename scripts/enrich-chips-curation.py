...
CHIPS_HOT_ENTRIES: dict[str, dict[str, Any]] = {
    ...
    "chips_people": {
        "mfg_date_start": "2026-01",
        "mfg_date_end": None,
        "discontinued": None,
        "socket": "Registry",
        "package": "combinatronic extract",
        "pins": 0,
        "country": "USA",
        "featured": True,
        "curator_note": "CHIPS People die — combinatronic truth extraction; real humans from registry + X archive; no harm, no censor.",
    },
    "chips_sid": {
