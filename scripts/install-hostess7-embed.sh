...
_H7V="$(python3 -c "import sys; sys.path.insert(0,'$(dirname "$0")/../src'); import hostess7; print(hostess7.__version__)" 2>/dev/null || echo "2.0.7")"
echo "=== Hostess7 embed install (${_H7V}) ==="
echo "  root:  $ROOT"
