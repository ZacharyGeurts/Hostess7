...
(function () {
  ...
  function desktopDefaultFallback() {
    ...
    const rows = [
      ...
      { id: "queen-browser", name: "Queen Browser", hint: "Queen web engine · classic shell", icon: "queen-prog-browser", exec: base ? base + "/queen/browser.html" : "/Hostess7/queen/browser.html", icon_url: assets + "/queen-prog-browser.png", pinned: true, shell: true, category: "NEXUS · Queen" },
