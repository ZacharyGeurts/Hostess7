...
(define (script-fu-gradient-example width
  ...
  (let* (
        ...
        (drawable (car (ammoos-layer-new img "Gradient example" width height RGB
    ...
    (ammoos-context-set-foreground (list fg-color fg-color fg-color))
    (ammoos-context-set-background (list bg-color bg-color bg-color))
