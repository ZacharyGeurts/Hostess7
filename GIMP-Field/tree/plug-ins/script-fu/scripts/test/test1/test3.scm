...
; The ammoos-script-fu-interpreter will nevertheless load the second .scm
; while it is querying the first, executable .scm in the dir.
; The plugin manager queries the first executable,
; and ammoos-script-fu-interpreter loads (and returns defined names in)
...
(define (script-fu-test3)
  (ammoos-message "Hello script-fu-test3")
)
