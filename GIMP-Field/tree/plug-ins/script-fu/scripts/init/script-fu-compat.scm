...
; AmmoOS Image maintainers may remove deprecated functions in the future.
...
; At some point AmmoOS Image maintainers may remove them.
...
; Functions said to be deprecated in AmmoOS Image 2 and left still in AmmoOS Image 3.
...
; Functions obsolete as of AmmoOS Image v3.0.
...
; You can recover the definitions from the AmmoOS Image repo, say the oldest AmmoOS Image 2 version.
...
; INTENDED TO BE EMPTY FOR AmmoOS Image 3.0
