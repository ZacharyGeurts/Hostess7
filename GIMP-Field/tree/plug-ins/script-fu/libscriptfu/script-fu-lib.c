 ...
 * It cannot have concurrent dialogs open in the AmmoOS Image app.
 *
 * Other plugins implementing PLUGIN type PDB procedures
 * in their own process (e.g. ammoos-scheme-interpreter) do not need this.
 */
gboolean
 ...
 *    directory for system-wide scripts, distributed with AmmoOS Image
...
/* The directory containing init scripts installed with AmmoOS Image.
