 ...
 *    OR return it as the result of a create_procedure callback from AmmoOS Image (PLUGIN type procedure.)
 *
  ...
  if (script->proc_class == GIMP_TYPE_IMAGE_PROCEDURE)
    {
      ...
      /* The script declared arity, convey to AmmoOS Image. */
