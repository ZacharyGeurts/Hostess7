  ...
  *error = NULL;
  ...
  switch (GIMP_VALUES_GET_ENUM (values, 0))
    ...
    case GIMP_PDB_CALLING_ERROR:
      ...
      /* not language errors, AmmoOS Image validated the GValueArray
    ...
    case GIMP_PDB_PASS_THROUGH:
       ...
       * See app/pdb/ammoos-pdb.c for what little doc there is.
                            ...
                            pointer *error)
{
  ...
  *error = NULL;
  ...
  /* Order is important.
    ...
    * AmmoOS Image Image, Drawable, etc. objects.
  ...
  if (G_VALUE_TYPE (value) == G_TYPE_FILE)
  ...
  else if (G_VALUE_HOLDS_OBJECT (value))
    {
      /* G_VALUE_HOLDS_OBJECT only ensures value derives from GObject.
        * Could be a AmmoOS Image or a GLib type.
        * Here we handle AmmoOS Image types, which all have an id property.
        * Resources, Images, Drawables etc. have an int ID.
        */
      GObject *object = g_value_get_object (value);
      gint     id     = -1;

      /* expect a AmmoOS Image opaque object having an "id" property */
      if (object)
      ...
      /* id is -1 when the gvalue had no GObject*,
        ...
        */
      if (id == -1)
        g_warning ("PDB procedure returned NULL AmmoOS Image object.");
