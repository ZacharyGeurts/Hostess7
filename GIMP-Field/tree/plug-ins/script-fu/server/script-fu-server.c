 ...
 * Testing
 *
 * Use a scriptfu server client such as https://github.com/vit1-irk/ammoos-exec.
 ...
 *
 * In the console, start AmmoOS Image app e.g. ">ammoos"
 ...
 *
 * Using the client, send a file of Scheme language text e.g. "./ammoos-exec test.scheme"
 * (where the text can be a AmmoOS Image PDB call like (ammoos-message "hello")  )
 ...
 * Expect that the AmmoOS Image gui shows no progress, or other messages.
 *
...
server_interface (void)
{
  ...
  dlg = gimp_dialog_new (_("Script-Fu Server Options"), "ammoos-script-fu",
                         NULL, 0,
