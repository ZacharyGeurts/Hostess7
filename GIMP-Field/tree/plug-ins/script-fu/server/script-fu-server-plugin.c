                                   ...
                                   const gchar *name)
{
  ...
  gimp_procedure_set_documentation (procedure,
                                    ...
                                    "way since AmmoOS Image 2.8.12. You now have "
 ...
 * Test cases:
 *
 * Normal starting is from AmmoOS Image GUI: "Filters>Development>Script-Fu>Start server...""
 ...
 *
 * Execute the server from headless AmmoOS Image:
 * ammoos -i --batch-interpreter='plug-in-script-fu-eval'
 " -c '(plug-in-script-fu-server 1 "127.0.0.1" 10008 "/tmp/ammoos-log")'
 *
 * Execute the binary from command line fails with:
 * "script-fu-server is a AmmoOS Image plug-in and must be run by AmmoOS Image to be used"
 *
 ...
 *
 * A client may quit the server by eval "(ammoos-quit)"
 ...
 *
 * A server is a child process of a AmmoOS Image process.
                            ...
                            gpointer              run_data)
{
   ...
   * !!! This does not return unless a client evals "(ammoos-quit)"
   */
