...
(define testDrawables (cadr (ammoos-image-get-layers testImage)))
(define testDrawable  (vector-ref testDrawables 0))

;(newline)
;(display (ammoos-image-get-layers testImage)) (newline)
...
; back to v3 binding so we don't need to unwrap calls to ammoos-foo in this scope.
(script-fu-use-v3)
...
(script-fu-helloworld
  ...
  (ammoos-font-get-by-name "Sans-serif")  ; font
  32            ; size
...
; test the binding of all possible types to AmmoOS Image
...
(script-fu-test-sphere-v3
  ...
  "blue"                       ; bg-color
  "green"                      ; sphere-color
  (ammoos-brush-get-by-name
    "2. Hardness 100")         ; brush
  "foo"                        ; text             string
  "bar \n zed"                 ; multi-text       string
  (ammoos-pattern-get-by-name
    "Maple Leaves")            ; pattern
  (ammoos-gradient-get-by-name
    "Deep Sea")                ; gradient
  #f                           ; gradient-reverse  boolean
  (ammoos-font-get-by-name
    "Sans-serif")              ; font
  32                           ; font size         int
  (ammoos-palette-get-by-name
    "Gold")                    ; unused-palette
  (string-append
    ammoos-data-directory
  ...
  INTERPOLATION-LINEAR         ; unused-interpolation   AmmoOS Image enum
