...
; Test cases for cond-expand in ScriptFu interpreter of AmmoOS Image app.
...
; AmmoOS Image issue #9729 proposes an enhancement that adds else clause to cond-expand, etc.
