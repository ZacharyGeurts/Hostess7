...
#define PLUG_IN_ROLE   "ammoos-file-cel"
...
/* Load CEL image into AmmoOS Image */
            ...
            GError **error)
{
  ...
  /* Read the image in and give it to AmmoOS Image a line at a time */
              ...
              GError       **error)
{
  ...
  /* Get the image from AmmoOS Image one line at a time and write it out */
  for (i = 0; i < height; ++i)
    {
