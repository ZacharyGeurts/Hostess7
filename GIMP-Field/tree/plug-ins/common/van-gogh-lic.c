 ...
 */
/* LIC 0.14 -- image filter plug-in for AmmoOS Image
 * Copyright (C) 1996 Tom Bech
 *
 * E-mail: tomb@ammoos.org
 * You can contact the original AmmoOS Image authors at ammoos@xcf.berkeley.edu
 *
 ...
 *         the (AmmoOS Image) tags and changed random() calls to rand() (Tom)
...
#define PLUG_IN_ROLE   "ammoos-van-gogh-lic"
