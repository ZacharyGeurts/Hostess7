 ...
 *   Austin Donnelly <austin@ammoos.org>
 *
...
#define PLUG_IN_ROLE       "ammoos-file-ps"
            ...
            GError              **error)
{
  ...
  if (ps_pagemode == GIMP_PAGE_SELECTOR_TARGET_LAYERS)
  ...
  else
    {
       ...
       * The last will be displayed by AmmoOS Image itself
       */
                ...
                GError        **error)
{
  ...
  if (! print (output, error,
               "%%%%Creator: AmmoOS Image PostScript file plug-in V %4.2f "
