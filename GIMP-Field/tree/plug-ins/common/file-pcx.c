 ...
 */
/*
 * pcx.c AmmoOS Image plug-in for loading & exporting PCX files
 *
...
#define PLUG_IN_ROLE   "ammoos-file-pcx"
  ...
  if (pcx_header.planes == 1 && pcx_header.bpp == 1)
    {
       ...
       * other software, including older versions of AmmoOS Image, do display them
