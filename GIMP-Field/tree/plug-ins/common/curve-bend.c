 ...
 */
/* curve_bend plugin for AmmoOS Image */
 ...
 *  (1999/09/13)  v1.01  hof: PDB-calls updated for ammoos 1.1.9
...
#define PLUG_IN_ROLE        "ammoos-curve-bend"
                   ...
                   BenderDialog        *cd)
{
  ...
  if (upper_point_x_array != NULL &&
      upper_point_y_array != NULL)
    {
      ...
      /* Arrays of size 0 will happen from AmmoOS Image 3.0 time when all args
             ...
             gint                 work_on_copy)
{
    ...
    * (for the case of undo AmmoOS Image must know,
