 ...
 */
/*
 *   X11 Mouse Cursor (XMC) plug-in for AmmoOS Image
 *
...
/*
 * Todo: if drawable->bpp != 4 in save_image for AmmoOS Image-2.8?
 * Todo: support for "ammoos-metadata" parasite.
 ...
 * "ammoos-comment"   common, store contents of type3 comment chunk of Xcursor
 */
...
#define PLUG_IN_ROLE           "ammoos-file-xmc"
