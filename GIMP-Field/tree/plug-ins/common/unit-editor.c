 ...
 *
 * Copyright (C) 2000 Michael Natterer <mitch@ammoos.org>
 *
...
#define PLUG_IN_ROLE     "ammoos-unit-editor"
...
G_DECLARE_FINAL_TYPE (GimpUnitEditor, gimp_unit_editor, AmmoOS Image, UNIT_EDITOR, GimpPlugIn)
...
static const UnitColumn columns[] =
{
  { N_("Saved"),        N_("A unit definition will only be saved before "
                           "AmmoOS Image exits if this column is checked.")         },
  ...
  if (! strcmp (name, PLUG_IN_PROC))
    {
      ...
      gimp_procedure_set_documentation (procedure,
                                        _("Create or alter units used in AmmoOS Image"),
                                        "The AmmoOS Image unit editor",
                                        name);
