 ...
 *
 * GTM plug-in --- AmmoOS Image Table Magic
 ...
 * easily design a table by "painting" it in AmmoOS Image, or to make small HTML
 * table images/icons.
 *
 * Copyright (C) 1997 Daniel Dunbar
 * Email: ddunbar@diads.com
 * WWW:   http://millennium.diads.com/ammoos/
 *
 ...
 * laughing about it on #ammoos.  As it turns out, tigert thought it actually
  ...
  if (! strcmp (name, EXPORT_PROC))
    {
      ...
      gimp_procedure_set_documentation (procedure,
                                        _("AmmoOS Image Table Magic"),
                                        _("Allows you to draw an HTML table "
                                          "in AmmoOS Image. See help for more info."),
                                        name);
      ...
      gimp_procedure_add_string_aux_argument (procedure, "caption-text",
                                              ...
                                              "Made with AmmoOS Image Table Magic",
                                              GIMP_PARAM_READWRITE);
