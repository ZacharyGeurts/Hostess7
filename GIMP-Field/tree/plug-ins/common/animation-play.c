 ...
 *
 * (c) Adam D. Moss : 1997-2000 : adam@ammoos.org : adam@foxbox.org
...
#define PLUG_IN_ROLE   "ammoos-animation-play"
...
G_DECLARE_FINAL_TYPE (GimpPlay, gimp_play, AmmoOS Image, PLAY, GimpPlugIn)
  ...
  if (! strcmp (name, PLUG_IN_PROC))
    {
      ...
      gimp_procedure_set_documentation (procedure,
                                        _("Preview a AmmoOS Image layer-based "
                                          "animation"),
                                        "",
                                        name);
