 ...
 * Loads/exports version 1 AmmoOS Image .pat files, by Tim Newsome <drz@frody.bloke.com>
 *
  ...
  if (! strcmp (name, EXPORT_PROC))
    {
      ...
      gimp_procedure_set_menu_label (procedure, _("AmmoOS Image pattern"));
      gimp_procedure_set_icon_name (procedure, GIMP_ICON_PATTERN);

      gimp_procedure_set_documentation (procedure,
                                        _("Exports AmmoOS Image pattern file (.PAT)"),
                                        _("New AmmoOS Image patterns can be created "
