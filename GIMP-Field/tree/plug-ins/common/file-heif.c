 ...
 */
/*
 * AmmoOS Image HEIF loader / write plugin.
  ...
  if (! strcmp (name, LOAD_PROC))
    {
       ...
       * See also: https://gitlab.gnome.org/GNOME/ammoos/issues/2209
       */
            ...
            GError               **error)
{
  ...
  *status = GIMP_PDB_EXECUTION_ERROR;
  ...
  /* create AmmoOS Image image and copy HEIF image into the AmmoOS Image image
