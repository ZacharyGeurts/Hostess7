 ...
 * They can be dropped for AmmoOS Image 3.0
 */
...
#define PLUG_IN_ROLE          "ammoos-compose"
                     ...
                     gint          num_images)
{
  ...
  /* Copy back to the format AmmoOS Image wants (and perform the conversion in itself) */
