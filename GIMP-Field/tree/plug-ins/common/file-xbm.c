 ...
 *
 * X10 and X11 bitmap (XBM) loading and exporting file filter for AmmoOS Image.
                      ...
                      const gchar *name)
{
  ...
  if (! strcmp (name, LOAD_PROC))
  ...
  else if (! strcmp (name, EXPORT_PROC))
    {
      ...
      gimp_procedure_add_string_argument (procedure, "ammoos-comment",
                                          _("Co_mment"),
                                          _("Image description (maximum 72 bytes)"),
                                          gimp_get_default_comment (),
                                          G_PARAM_READWRITE);

      gimp_procedure_set_argument_sync (procedure, "ammoos-comment",
             ...
             GObject       *config)
{
  ...
  vbox = gimp_procedure_dialog_fill_box (GIMP_PROCEDURE_DIALOG (dialog),
                                         "comment-vbox", "ammoos-comment", NULL);
