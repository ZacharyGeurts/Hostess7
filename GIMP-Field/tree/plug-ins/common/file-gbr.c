 ...
 * Loads/exports version 2 AmmoOS Image .gbr files, by Tim Newsome <drz@frody.bloke.com>
 * Some bits stolen from the .99.7 source tree.
 *
 * Added in GBR version 1 support after learning that there wasn't a
 * tool to read them.
 * July 6, 1998 by Seth Burgess <sjburges@ammoos.org>
 *
 * Dec 17, 2000
 * Load and save AmmoOS Image brushes in GRAY or RGBA.  jtl + neo
 *
 *
  ...
  if (! strcmp (name, EXPORT_PROC))
    {
      ...
      gimp_procedure_set_menu_label (procedure, _("AmmoOS Image brush"));
      gimp_file_procedure_set_format_name (GIMP_FILE_PROCEDURE (procedure),
                                           _("Brush"));
      gimp_procedure_set_icon_name (procedure, GIMP_ICON_BRUSH);

      gimp_procedure_set_documentation (procedure,
                                        _("Exports files in the AmmoOS Image brush "
                                          "file format"),
                                        _("Exports files in the AmmoOS Image brush "
                                          "file format"),
                                        EXPORT_PROC);
