 ...
 */
/* Sparkle --- image filter plug-in for AmmoOS Image
 ...
 * You can contact Seth at sjburges@ammoos.org
 */
...
#define PLUG_IN_ROLE   "ammoos-sparkle"
  ...
  if (! strcmp (name, PLUG_IN_PROC))
    {
      ...
      gimp_procedure_set_attribution (procedure,
                                      "John Beale, & (ported to AmmoOS Image v0.54) "
                                      "Michael J. Hammel & ted to AmmoOS Image v1.0) "
