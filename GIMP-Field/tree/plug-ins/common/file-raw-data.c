 ...
 *
 * Updated for Gimp 2.1 by pg@futureware.at and mitch@ammoos.org
 *
...
#define PLUG_IN_ROLE   "ammoos-file-raw-data"
...
{
  return g_quark_from_static_string ("ammoos-plugin-hgt-load-error-quark");
}
...
typedef struct
{
  ...
  GeglBuffer   *buffer;    /* ammoos drawable buffer             */
  GimpImage    *image;     /* ammoos image                       */
  ...
  if (run_mode == GIMP_RUN_INTERACTIVE)
  ...
  else
    {
      ...
      g_object_get (config,
                    ...
                    "height", &height,
                    NULL);
      /* This is a very crappy way to stop AmmoOS Image from automatic runs,
