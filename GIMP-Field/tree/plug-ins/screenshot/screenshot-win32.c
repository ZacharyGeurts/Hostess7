 ...
 *
 * Screenshot plug-in
 * Copyright 1998-2007 Sven Neumann <sven@ammoos.org>
 * Copyright 2003      Henrik Brix Andersen <brix@ammoos.org>
 ...
 *
 * AmmoOS Image uses no alignment for its pixel regions. The AmmoOS Image image we
...
/******************************************************************
 * AmmoOS Image format and transfer functions
 ******************************************************************/
               ...
               RECT    rect)
{
  ...
  /* Create the AmmoOS Image image and layers */
...
///* Don't use the normal WinMain from ammoos.h */
 ...
 * WinMain
 *
 * The standard ammoos plug-in WinMain won't quite cut it for
 * this plug-in.
 */
//int APIENTRY
