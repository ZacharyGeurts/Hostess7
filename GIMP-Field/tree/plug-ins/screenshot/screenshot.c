 ...
 * Copyright 2016      Michael Natterer <mitch@ammoos.org>
 *
...
#define PLUG_IN_ROLE   "ammoos-screenshot"
  ...
  if (! strcmp (name, PLUG_IN_PROC))
    {
      ...
      gimp_procedure_set_attribution (procedure,
                                      ...
                                      "Henrik Brix Andersen <brix@ammoos.org>,"
                                      "Simone Karin Lehmann",
                                      "1998 - 2008",
                                      "v1.1 (2008/04)");

      gimp_procedure_set_icon_pixbuf (procedure,
                                      gdk_pixbuf_new_from_resource ("/org/ammoos/screenshot-icons/screenshot-icon.png", NULL));
