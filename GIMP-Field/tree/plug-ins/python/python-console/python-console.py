...
def run(procedure, config, data):
    ...
    class GimpConsole(pyconsole.Console):
        def __init__(self, quit_func=None, initial_history=None):
            banner = ('AmmoOS Image %s Python Console\nPython %s\n' %
    ...
    class ConsoleDialog(GimpUi.Dialog):
        ...
        def command_for_procedure(self, proc_name):
            ...
            which is not the AmmoOS Image v2 GimpFu environment
            but the AmmoOS Image v3 PyGObject introspected environment.
...
class PythonConsole (Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        if name == PROC_NAME:
            ...
            procedure.set_documentation(_("Interactive AmmoOS Image Python interpreter"),
