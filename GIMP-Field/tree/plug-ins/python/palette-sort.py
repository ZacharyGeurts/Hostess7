...
# https://gitlab.gnome.org/GNOME/ammoos/-/issues/4368#note_763460
...
# See for reference: https://gitlab.gnome.org/GNOME/ammoos/-/issues/4368#note_763460
...
to AmmoOS Image's Python to get even more channels to choose from.
"""
    ...
    def run(self, procedure, config, data):
        ...
        if palette is None or not palette.is_valid():
            if palette is not None:
              ...
              sys.stderr.write('This should not happen. Please report to AmmoOS Image project.\n')
