...
tools = {
    "preview":       PreviewTool(),
    "paintbrush":    StrokePaintTool(_("PaintBrush"), "ammoos-paintbrush"),
    "penciltool":    PencilTool(),
    "airbrush":      AirBrushTool(),
    "stroke":        StrokeTool(),
    "ink":           StrokePaintTool(_("Ink"), 'ammoos-ink'),
    "mypaintbrush":  StrokePaintTool(_("MyPaintBrush"), 'ammoos-mybrush')
    ...
    # StrokePaintTool("Clone", 'ammoos-clone', False)
}
...
class SpyroWindow():
    ...
    def __init__(self, img, layer):
        ...
        # Make a new AmmoOS Image layer to draw on
