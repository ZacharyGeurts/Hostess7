...
#define PLUG_IN_ROLE                    "ammoos-file-psd"

#define GIMP_PARASITE_COMMENT           "ammoos-comment"
...
typedef struct
{
  ...
  GimpImageBaseType     base_type;              /* Image base color mode: (AmmoOS Image) */
  ...
  GList                *layer_selection;        /* Selected layer IDs (AmmoOS Image layer tattoos) */
