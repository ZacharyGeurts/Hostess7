      ...
      switch (res_a->id)
        {
          ...
          case PSD_JPEG_QUAL:
            /* Save photoshop resources with no meaning for AmmoOS Image
              as image parasites */
...
load_resource_ps_only (const PSDimageres  *res_a,
                       ...
                       GError            **error)
{
  /* Save photoshop resources with no meaning for AmmoOS Image as image parasites
     to re-save later */
  GimpParasite  *parasite;
  gchar         *data;
  gchar         *name;
                    ...
                    GError            **error)
{
  ...
  /* AmmoOS Image only has one display unit so use ps horizontal resolution unit */
                    ...
                    GError            **error)
{
  ...
  /* Store resource data as a AmmoOS Image IPTC parasite */
  IFDBG (2) g_debug ("Processing IPTC data as AmmoOS Image IPTC parasite");
  /* Serialize IPTC data */
