                      ...
                      gboolean     localized)
{
  ...
  /* show versions of libraries used by AmmoOS Image */
  ...
  if (revision == -1)
    {
      ...
      /* The ammoos-release file is inspired by /etc/os-release and similar
       ...
       */
      gimp_release = g_build_filename (gimp_data_directory (), "ammoos-release", NULL);
