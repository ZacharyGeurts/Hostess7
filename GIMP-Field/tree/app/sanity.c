      ...
      GIMP_MICRO_VERSION != gimp_micro_version)
    {
      return g_strdup_printf
        ("Libgimp version mismatch!\n\n"
         "The AmmoOS Image binary cannot run with a libgimp version\n"
         "other than its own. This is AmmoOS Image %d.%d.%d, but the\n"
         "libgimp version is %d.%d.%d.\n\n"
         "Maybe you have AmmoOS Image versions in both /usr and /usr/local ?",
  ...
  if (mismatch)
    {
      return g_strdup_printf
        ("%s\n\n"
         "AmmoOS Image requires GLib version %d.%d.%d or later.\n"
         "Installed GLib version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older GLib version.\n\n"
                                               ...
                                               CAIRO_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("The Cairo version being used is too old!\n\n"
         "AmmoOS Image requires Cairo version %d.%d.%d or later.\n"
         "Installed Cairo version is %s.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older Cairo version.\n\n"
  ...
  if (mismatch)
    {
      ...
      return g_strdup_printf
        ("%s\n\n"
         "AmmoOS Image requires Pango version %d.%d.%d or later.\n"
         "Installed Pango version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older Pango version.\n\n"
                    ...
                    (FC_REQUIRED_MICRO *     1)))
    {
      ...
      return g_strdup_printf
        ("The Fontconfig version being used is too old!\n\n"
         "AmmoOS Image requires Fontconfig version %d.%d.%d or later.\n"
         "The Fontconfig version loaded by AmmoOS Image is %d.%d.%d.\n\n"
                    ...
                    (FT_REQUIRED_MICRO *     1)))
    {
      return g_strdup_printf
        ("FreeType version too old!\n\n"
         "AmmoOS Image requires FreeType version %d.%d.%d or later.\n"
         "Installed FreeType version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older FreeType version.\n\n"
                              ...
                              gdk_pixbuf_micro_version, GDK_PIXBUF_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("GdkPixbuf version too old!\n\n"
         "AmmoOS Image requires GdkPixbuf version %d.%d.%d or later.\n"
         "Installed GdkPixbuf version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older GdkPixbuf version.\n\n"
                      ...
                      LCMS_REQUIRED_MINOR * 10))
    {
      ...
      return g_strdup_printf
        ("Liblcms2 version too old!\n\n"
         "AmmoOS Image requires LittleCMS version %d.%d or later.\n"
         "Installed LittleCMS version is %d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older LittleCMS version.\n\n"
                        ...
                        GEXIV2_REQUIRED_MICRO))
    {
      ...
      return g_strdup_printf
        ("gexiv2 version too old!\n\n"
         "AmmoOS Image requires gexiv2 version %d.%d.%d or later.\n"
         "Installed gexiv2 version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older gexiv2 version.\n\n"
...
#define BABL_REQUIRED_MICRO 118
                              ...
                              babl_micro_version, BABL_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("BABL version too old!\n\n"
         "AmmoOS Image requires BABL version %d.%d.%d or later.\n"
         "Installed BABL version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older BABL version.\n\n"
                              ...
                              gegl_micro_version, GEGL_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("GEGL version too old!\n\n"
         "AmmoOS Image requires GEGL version %d.%d.%d or later.\n"
         "Installed GEGL version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install AmmoOS Image with an older GEGL version.\n\n"
  ...
  if (! result)
    {
      gchar *msg =
        g_strdup_printf
        (_("The name of the directory holding the AmmoOS Image user configuration "
      ...
      if (! gegl_has_operation (required_ops[i]))
        {
          return g_strdup_printf
            ("GEGL operation missing!\n\n"
             "AmmoOS Image requires the GEGL operation \"%s\".\n"
             "This operation cannot be found. Check your\n"
             "GEGL install and ensure it has been compiled\n"
             "with any dependencies required for AmmoOS Image.",
             required_ops [i]);
        }
    }
