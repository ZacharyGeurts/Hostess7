                                ...
                                GimpDisplay           *display)
{
  ...
  if (sc->paste == NULL)
    {
      GimpObject *paste = gimp_clipboard_get_object (tool->tool_info->ammoos);
