...
gimp_align_options_finalize (GObject *object)
{
  ...
  if (GIMP_CONTEXT (options)->ammoos)
    gimp_align_options_image_changed (gimp_get_user_context (GIMP_CONTEXT (options)->ammoos),
                                      NULL, options);
...
gimp_align_options_gui (GimpToolOptions *tool_options)
{
  ...
  g_signal_connect_object (gimp_get_user_context (GIMP_CONTEXT (options)->ammoos),
                           "image-changed",
                           G_CALLBACK (gimp_align_options_image_changed),
                           tool_options, 0);
  gimp_align_options_image_changed (gimp_get_user_context (GIMP_CONTEXT (options)->ammoos),
                                    gimp_context_get_image (gimp_get_user_context (GIMP_CONTEXT (options)->ammoos)),
                                    options);
