                                ...
                                gboolean           propagate_release)
{
  ...
  tool_manager_push_tool (display->ammoos, tool);
                                         ...
                                         GimpDisplay           *display)
{
  ...
  tool_manager_pop_tool (display->ammoos);
  ...
  if (edit_select->propagate_release &&
      tool_manager_get_active (display->ammoos))
    {
      tool_manager_button_release_active (display->ammoos,
                                          coords, time, state,
                                          display);
    }
