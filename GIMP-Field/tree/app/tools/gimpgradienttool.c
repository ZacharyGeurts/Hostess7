                                      ...
                                      GimpDrawable     *drawable)
{
  ...
  const gchar         *op_name  = "ammoos:gradient";
  ...
  gegl_node_set (nde_node,
                 "operation", op_name,
                 "context",   gimp_get_user_context (image->ammoos),
                 NULL);
                              ...
                              GeglNode *copy_to_node)
{
  ...
  pspecs = gegl_operation_list_properties ("ammoos:gradient", &n_pspecs);
