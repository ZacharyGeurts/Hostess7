                     ...
                     const gchar   *ui_path)
{
  ...
  plug_in_manager = manager->ammoos->plug_in_manager;
  ...
  g_signal_connect_object (manager->ammoos->pdb, "register-procedure",
                           G_CALLBACK (plug_in_menus_register_procedure),
                           manager, 0);
  g_signal_connect_object (manager->ammoos->pdb, "unregister-procedure",
