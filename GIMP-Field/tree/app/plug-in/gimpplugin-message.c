                             ...
                             GimpWireMessage *msg)
{
  ...
  switch (msg->type)
    ...
    case GP_CONFIG:
      gimp_message (plug_in->manager->ammoos, NULL, GIMP_MESSAGE_ERROR,
                    "Plug-in \"%s\"\n(%s)\n\n"
                              ...
                              GPTileReq  *request)
{
  ...
  drawable = (GimpDrawable *) gimp_item_get_by_id (plug_in->manager->ammoos,
  ...
  switch (proc_frame->error_handler)
    ...
    case GIMP_PDB_ERROR_HANDLER_INTERNAL:
      if (error->domain == GIMP_PDB_ERROR)
        {
          gimp_message (plug_in->manager->ammoos,
                              ...
                              GPProcRun  *proc_run)
{
  ...
  procedure = gimp_pdb_lookup_procedure (plug_in->manager->ammoos->pdb,
                                         canonical);

  if (! procedure)
    {
      proc_name = gimp_pdb_lookup_compat_proc_name (plug_in->manager->ammoos->pdb,
                                                    canonical);
      ...
      if (proc_name)
        {
          ...
          if (plug_in->manager->ammoos->pdb_compat_mode == GIMP_PDB_COMPAT_WARN)
            {
              gimp_message (plug_in->manager->ammoos, NULL, GIMP_MESSAGE_WARNING,
                            "Plug-in \"%s\"\n(%s)\n"
  ...
  args = _gimp_gp_params_to_value_array (plug_in->manager->ammoos,
  ...
  return_vals = gimp_pdb_execute_procedure_by_name_args (plug_in->manager->ammoos->pdb,
   ...
   *  closed the plug-in (e.g. if the procedure is ammoos-quit)
   */
  if (plug_in->open)
    {
      GPProcReturn proc_return;
       ...
       *  since proc_name may have been remapped by ammoos->procedural_compat_ht
                                 ...
                                 GPProcReturn *proc_return)
{
  ...
  proc_frame->return_vals =
    _gimp_gp_params_to_value_array (plug_in->manager->ammoos,
