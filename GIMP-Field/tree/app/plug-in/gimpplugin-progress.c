                             ...
                             GimpDisplay *display)
{
  ...
  if (! proc_frame->progress)
    {
      proc_frame->progress = gimp_new_progress (plug_in->manager->ammoos,
                                                display);
  ...
  if (proc_frame->progress)
    {
      ...
      if (proc_frame->progress_created)
        {
          gimp_free_progress (plug_in->manager->ammoos, proc_frame->progress);
...
gimp_plug_in_progress_get_window_id (GimpPlugIn *plug_in)
{
  ...
  if (proc_frame->progress)
    ...
    return gimp_get_display_window_id (plug_in->manager->ammoos, plug_in->display);
                               ...
                               const gchar *progress_callback)
{
  ...
  proc_frame->progress = g_object_new (GIMP_TYPE_PDB_PROGRESS,
                                       "pdb",           plug_in->manager->ammoos->pdb,
