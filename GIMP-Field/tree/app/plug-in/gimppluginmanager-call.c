                               ...
                               GimpDisplay         *display)
{
  ...
  if (plug_in)
    {
      GimpCoreConfig    *core_config    = manager->ammoos->config;
      ...
      icon_theme_dir = gimp_get_icon_theme_dir (manager->ammoos);
      ...
      config.use_cpu_accel        = manager->ammoos->use_cpu_accel;
      ...
      config.wm_class             = (gchar *) gimp_get_program_class (manager->ammoos);
      config.display_name         = gimp_get_display_name (manager->ammoos,
                                                           display_id,
                                                           &monitor,
                                                           &config.monitor_number);
      config.timestamp            = gimp_get_user_time (manager->ammoos);
