                          ...
                          gpointer    data)
{
  ...
  if (args)
    {
      if (procedure_commands_run_procedure_async (procedure, ammoos,
...
#define RESET_FILTERS_DIALOG_KEY "ammoos-reset-all-filters-dialog"

  dialog = dialogs_get_dialog (G_OBJECT (ammoos), RESET_FILTERS_DIALOG_KEY);
  ...
  if (! dialog)
    {
      ...
      dialogs_attach_dialog (G_OBJECT (ammoos), RESET_FILTERS_DIALOG_KEY, dialog);
    }
                            ...
                            Gimp      *ammoos)
{
  ...
  if (response_id == GTK_RESPONSE_OK)
    gimp_plug_in_manager_data_free (ammoos->plug_in_manager);
}
