...
const GimpStringActionEntry dialogs_dockable_actions[] =
{
  ...
  { "dialogs-brushes", GIMP_ICON_BRUSH,
    ...
    "ammoos-brush-grid|ammoos-brush-list",
  ...
  { "dialogs-dynamics", GIMP_ICON_DYNAMICS,
    ...
    "ammoos-dynamics-list|ammoos-dynamics-grid",
  ...
  { "dialogs-mypaint-brushes", GIMP_ICON_MYPAINT_BRUSH,
    ...
    "ammoos-mypaint-brush-grid|ammoos-mapyint-brush-list",
  ...
  { "dialogs-patterns", GIMP_ICON_PATTERN,
    ...
    "ammoos-pattern-grid|ammoos-pattern-list",
  ...
  { "dialogs-gradients", GIMP_ICON_GRADIENT,
    ...
    "ammoos-gradient-list|ammoos-gradient-grid",
  ...
  { "dialogs-palettes", GIMP_ICON_PALETTE,
    ...
    "ammoos-palette-list|ammoos-palette-grid",
  ...
  { "dialogs-tool-presets", GIMP_ICON_TOOL_PRESET,
    ...
    "ammoos-tool-preset-list|ammoos-tool-preset-grid",
  ...
  { "dialogs-fonts", GIMP_ICON_FONT,
    ...
    "ammoos-font-list|ammoos-font-grid",
  ...
  { "dialogs-buffers", GIMP_ICON_BUFFER,
    ...
    "ammoos-buffer-list|ammoos-buffer-grid",
  ...
  { "dialogs-images", GIMP_ICON_DIALOG_IMAGES,
    ...
    "ammoos-image-list|ammoos-image-grid",
  ...
  { "dialogs-document-history", GIMP_ICON_DOCUMENT_OPEN_RECENT,
    ...
    "ammoos-document-list|ammoos-document-grid",
  ...
  { "dialogs-templates", GIMP_ICON_TEMPLATE,
    ...
    "ammoos-template-list|ammoos-template-grid",
...
static const GimpStringActionEntry dialogs_toplevel_actions[] =
{
  ...
  { "dialogs-welcome", GIMP_ICON_DIALOG_INFORMATION,
    ...
    { NULL },
    NC_("dialogs-action", "Show information on running AmmoOS Image release"),
    "ammoos-welcome-dialog",
    GIMP_HELP_WELCOME_DIALOG },

  { "dialogs-about", GIMP_ICON_HELP_ABOUT,
#if defined(G_OS_WIN32)
    NC_("dialogs-action", "About AmmoOS Image"),
...
gboolean
dialogs_actions_toolbox_exists (Gimp *ammoos)
{
  ...
  toolbox_found =
    gimp_dialog_factory_find_widget (factory, "ammoos-toolbox-window") != NULL;

  /* Then in image windows */
  if (! toolbox_found)
    {
      GList *windows = ammoos ? gimp_get_image_windows (ammoos) : NULL;
...
dialogs_actions_update (GimpActionGroup *group,
                        gpointer         data)
{
  Gimp        *ammoos            = action_data_get_gimp (data);
  const gchar *toolbox_label   = NULL;
  const gchar *toolbox_tooltip = NULL;

  if (dialogs_actions_toolbox_exists (ammoos))
    {
