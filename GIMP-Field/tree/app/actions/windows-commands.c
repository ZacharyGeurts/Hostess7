                                 ...
                                 gpointer    data)
{
  ...
  if (active != GIMP_GUI_CONFIG (ammoos->config)->hide_docks)
                                             ...
                                             gpointer    data)
{
  ...
  if (active != GIMP_GUI_CONFIG (ammoos->config)->single_window_mode)
    g_object_set (ammoos->config,
                                ...
                                gpointer    data)
{
  ...
  if (active != GIMP_GUI_CONFIG (ammoos->config)->show_tabs)
    g_object_set (ammoos->config,
                  "show-tabs", active,
                  NULL);
}
                                        ...
                                        gpointer    data)
{
  ...
  if (position != GIMP_GUI_CONFIG (ammoos->config)->tabs_position)
    g_object_set (ammoos->config,
                                        ...
                                        gpointer    data)
{
  ...
  index = gimp_container_get_child_index (ammoos->displays,
                                          GIMP_OBJECT (display));
  index++;

  if (index >= gimp_container_get_n_children (ammoos->displays))
    index = 0;

  display = GIMP_DISPLAY (gimp_container_get_child_by_index (ammoos->displays,
                                                             index));
                                            ...
                                            gpointer    data)
{
  ...
  if (index < 0)
    index = gimp_container_get_n_children (ammoos->displays) - 1;
                                  ...
                                  gpointer    data)
{
  ...
  if (entry && strcmp ("ammoos-toolbox-window", entry->identifier) == 0 &&
      dialogs_actions_toolbox_exists (ammoos))
    {
      gimp_message (ammoos,
