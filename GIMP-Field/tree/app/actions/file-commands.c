...
static void        file_open_dialog_show        (Gimp         *ammoos,
                                                 GtkWidget    *parent,
                                                 const gchar  *title,
                                                 GimpImage    *image,
                                                 GFile        *file,
...
static GtkWidget * file_save_dialog_show        (Gimp         *ammoos,
                                                 GimpImage    *image,
                                                 GtkWidget    *parent,
                                                 const gchar  *title,
                                                 ...
                                                 GimpDisplay  *display);
static GtkWidget * file_export_dialog_show      (Gimp         *ammoos,
                                                 GimpImage    *image,
                                                 GtkWidget    *parent,
                                                 GimpDisplay  *display);
                        ...
                        gpointer    data)
{
  ...
  GtkWidget   *widget;
  GimpImage   *image;
  return_if_no_gimp (ammoos, data);
  return_if_no_widget (widget, data);

  image = action_data_get_image (data);

  file_open_dialog_show (ammoos, widget,
                         _("Open Image"),
                                 ...
                                 gpointer    data)
{
  ...
  gimp_dialog_factory_dialog_new (gimp_dialog_factory_get_singleton (),
                                  ...
                                  NULL /*ui_manager*/,
                                  widget,
                                  "ammoos-file-open-location-dialog", -1, TRUE);
}
                               ...
                               gpointer    data)
{
  ...
  num_entries = gimp_container_get_n_children (ammoos->documents);

  if (index >= num_entries)
    return;

  imagefile = (GimpImagefile *)
    gimp_container_get_child_by_index (ammoos->documents, index);
  ...
  if (imagefile)
    {
      ...
      image = file_open_with_display (ammoos, action_data_get_context (data),
                                      progress,
                                      file, FALSE,
  ...
  switch (save_mode)
    ...
    case GIMP_SAVE_MODE_SAVE_AND_CLOSE:
      ...
      if ((gimp_image_is_dirty (image) ||
           ! GIMP_GUI_CONFIG (image->ammoos->config)->trust_dirty_flag) ||
          file == NULL)
        {
          ...
          if (valid_file && ! save_proc)
            {
              save_proc =
                gimp_plug_in_manager_file_procedure_find (image->ammoos->plug_in_manager,
    ...
    case GIMP_SAVE_MODE_SAVE_AS:
      file_save_dialog_show (ammoos, image, widget,
                             _("Save Image"), FALSE,
    ...
    case GIMP_SAVE_MODE_EXPORT_AS:
      file_export_dialog_show (ammoos, image, widget, display);
      break;
...
#define REVERT_DIALOG_KEY "ammoos-revert-confirm-dialog"
  ...
  if (file)
    {
      ...
      gimp_clipboard_set_text (ammoos, uri);
      g_free (uri);
    }
}
                        ...
                        gpointer    data)
{
  ...
  gimp_exit (ammoos, FALSE);
}

void
file_file_open_dialog (Gimp      *ammoos,
                       GFile     *file,
                       GtkWidget *parent)
{
  file_open_dialog_show (ammoos, parent,
                         _("Open Image"),
...
static void
file_open_dialog_show (Gimp        *ammoos,
                       GtkWidget   *parent,
                       const gchar *title,
                       GimpImage   *image,
                       GFile       *file,
                       ...
                       gboolean     open_as_link)
{
  ...
  dialog = gimp_dialog_factory_dialog_new (gimp_dialog_factory_get_singleton (),
                                           ...
                                           NULL /*ui_manager*/,
                                           parent,
                                           "ammoos-file-open-dialog", -1, FALSE);
  ...
  if (dialog)
    {
      ...
      if (! file)
        file = g_object_get_data (G_OBJECT (ammoos),
      ...
      else if (ammoos->default_folder)
        {
          gtk_file_chooser_set_current_folder_file (GTK_FILE_CHOOSER (dialog),
                                                    ammoos->default_folder, NULL);
        }
...
static GtkWidget *
file_save_dialog_show (Gimp        *ammoos,
                       GimpImage   *image,
                       GtkWidget   *parent,
                       const gchar *title,
                       gboolean     save_a_copy,
...
#define SAVE_DIALOG_KEY "ammoos-file-save-dialog"
  ...
  if (response_id == FILE_SAVE_RESPONSE_OTHER_DIALOG)
    {
      ...
      other = file_export_dialog_show (GIMP_FILE_DIALOG (file_dialog)->image->ammoos,
...
static GtkWidget *
file_export_dialog_show (Gimp        *ammoos,
                         GimpImage   *image,
                         GtkWidget   *parent,
                         GimpDisplay *display)
{
...
#define EXPORT_DIALOG_KEY "ammoos-file-export-dialog"
  ...
  if (response_id == FILE_SAVE_RESPONSE_OTHER_DIALOG)
    {
      ...
      other = file_save_dialog_show (GIMP_FILE_DIALOG (file_dialog)->image->ammoos,
                                     GIMP_FILE_DIALOG (file_dialog)->image,
                                     GTK_WIDGET (parent),
                                     _("Save Image"),
                                     FALSE, FALSE, NULL);
                            ...
                            gpointer     data)
{
  ...
  gimp_container_add (image->ammoos->templates, GIMP_OBJECT (template));
  ...
  if (response_id == GTK_RESPONSE_OK)
    {
      ...
      new_image = file_open_image (ammoos, gimp_get_user_context (ammoos),
