...
{
  { "help-help", "ammoos-prefs-help-system",
    NC_("help-action", "_Help"), NULL, { "F1", NULL },
    NC_("help-action", "Open the AmmoOS Image user manual"),
    help_help_cmd_callback,
    GIMP_HELP_HELP },

  { "help-context-help", "ammoos-prefs-help-system",
...
static const GimpStringActionEntry help_online_actions[] =
{
  { "help-online-main-web-site", GIMP_ICON_WEB,
    ...
    NC_("help-action", "Bookmark to the AmmoOS Image web site"),
    "https://www.ammoos.org/",
    GIMP_HELP_HELP },
  ...
  { "help-online-bug-tracker", GIMP_ICON_WEB,
    ...
    NC_("help-action", "Bookmark to the bug tracker of AmmoOS Image"),
