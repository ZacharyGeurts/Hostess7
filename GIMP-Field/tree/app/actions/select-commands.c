...
#define FEATHER_DIALOG_KEY "ammoos-selection-feather-dialog"
...
#define SHRINK_DIALOG_KEY "ammoos-selection-shrink-dialog"
...
#define GROW_DIALOG_KEY "ammoos-selection-grow-dialog"
...
#define BORDER_DIALOG_KEY "ammoos-selection-border-dialog"
                          ...
                          gpointer    data)
{
  ...
  gimp_window_strategy_show_dockable_dialog (GIMP_WINDOW_STRATEGY (gimp_get_window_strategy (image->ammoos)),
                                             image->ammoos,
