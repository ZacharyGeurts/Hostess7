                         ...
                         gpointer    data)
{
  ...
  tool_manager_swap_tools (ammoos, FALSE);
}
                           ...
                           gpointer    data)
{
  ...
  /*  special case ammoos-rotate-tool being called from the Image or Layer
   *  menus
   */
  if (strcmp (tool_name, "ammoos-rotate-layer") == 0)
    {
      tool_name          = "ammoos-rotate-tool";
      set_transform_type = TRUE;
      transform_type     = GIMP_TRANSFORM_TYPE_LAYER;
    }
  else if (strcmp (tool_name, "ammoos-rotate-image") == 0)
    {
      tool_name          = "ammoos-rotate-tool";
      set_transform_type = TRUE;
  ...
  tool_info = gimp_get_tool_info (ammoos, tool_name);
  ...
  if (set_transform_type)
    {
      GimpTool *tool = tool_manager_get_active (ammoos);
                            ...
                            gpointer    data)
{
  ...
  tool = tool_manager_get_active (context->ammoos);
