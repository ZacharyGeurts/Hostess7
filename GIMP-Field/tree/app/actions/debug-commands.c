                                ...
                                gpointer    data)
{
  ...
  gimp_object_get_memsize (GIMP_OBJECT (ammoos), NULL);
                                            ...
                                            gpointer    data)
{
  ...
  manager = menus_get_image_manager_singleton (display->ammoos);
                                       ...
                                       gpointer    data)
{
  ...
  GimpContext *user_context = gimp_get_user_context (ammoos);

  debug_print_qdata (GIMP_OBJECT (ammoos));
  ...
  if (buffer)
    {
      ...
      new_image = gimp_create_image_from_buffer (source_image->ammoos,
                                                 buffer, new_name);
