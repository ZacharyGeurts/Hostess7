  ...
  if (! gimp_dashboard_log_is_recording (dashboard))
    {
      ...
      #define LOG_RECORD_KEY "ammoos-dashboard-log-record-dialog"
      ...
      if (! dialog)
        {
          ...
          info = g_object_get_data (G_OBJECT (dashboard),
                                    "ammoos-dashboard-log-dialog-info");
          ...
          if (! info)
            {
              ...
              g_object_set_data_full (
                G_OBJECT (dashboard),
                "ammoos-dashboard-log-dialog-info", info,
          ...
          default_filename = g_strdup_printf ("ammoos-performance-%s.log",
                                              timestamp);
      ...
      if (! gimp_dashboard_log_stop_recording (dashboard, &error))
        {
          gimp_message_literal (
            gimp_editor_get_ui_manager (GIMP_EDITOR (dashboard))->ammoos,
                                       ...
                                       gpointer    data)
{
  ...
  #define LOG_ADD_MARKER_KEY "ammoos-dashboard-log-add-marker-dialog"
