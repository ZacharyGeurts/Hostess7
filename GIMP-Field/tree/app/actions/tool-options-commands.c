...
static void   tool_options_show_preset_editor (Gimp           *ammoos,
                                               GimpEditor     *editor,
                                           ...
                                           gpointer    user_data)
{
  ...
  Gimp        *ammoos    = gimp_editor_get_ui_manager (editor)->ammoos;
  GimpContext *context = gimp_get_user_context (ammoos);
  GimpData    *data;

  data = gimp_data_factory_data_new (context->ammoos->tool_preset_factory,
                                     context, _("Untitled"));

  tool_options_show_preset_editor (ammoos, editor, GIMP_TOOL_PRESET (data));
}
  ...
  if (preset)
    {
      ...
      tool_options_show_preset_editor (ammoos, editor, preset);
    }
}
...
{
  GimpEditor     *editor    = GIMP_EDITOR (data);
  GimpContext    *context   = gimp_get_user_context (gimp_editor_get_ui_manager (editor)->ammoos);
  GimpToolInfo   *tool_info = gimp_context_get_tool (context);
  GimpToolPreset *preset;
  gint            index;
  ...
  if (preset &&
    ...
    {
      GimpDataFactory *factory = context->ammoos->tool_preset_factory;
      GtkWidget       *dialog;
...
static void
tool_options_show_preset_editor (Gimp           *ammoos,
                                 GimpEditor     *editor,
                                 GimpToolPreset *preset)
{
  GtkWidget *dockable;
