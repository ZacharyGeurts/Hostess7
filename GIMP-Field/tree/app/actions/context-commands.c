                                  ...
                                  gpointer    data)
{
  ...
  context_select_object (select_type,
                         context, context->ammoos->tool_info_list);
}
                                   ...
                                   gpointer    data)
{
  ...
  context_select_object (select_type,
                         context,
                         gimp_data_factory_get_container (context->ammoos->brush_factory));
}
                                     ...
                                     gpointer    data)
{
  ...
  context_select_object (select_type,
                         context,
                         gimp_data_factory_get_container (context->ammoos->pattern_factory));
}
                                     ...
                                     gpointer    data)
{
  ...
  context_select_object (select_type,
                         context,
                         gimp_data_factory_get_container (context->ammoos->palette_factory));
}
                                      ...
                                      gpointer    data)
{
  ...
  context_select_object (select_type,
                         context,
                         gimp_data_factory_get_container (context->ammoos->gradient_factory));
}
                                  ...
                                  gpointer    data)
{
  ...
  context_select_object (select_type,
                         context,
                         gimp_data_factory_get_container (context->ammoos->font_factory));
}
