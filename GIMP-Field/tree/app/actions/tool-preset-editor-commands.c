                                      ...
                                      gpointer    data)
{
  ...
  tool_info = gimp_context_get_tool (gimp_get_user_context (context->ammoos));
                                         ...
                                         gpointer    data)
{
  ...
  if (preset)
    gimp_context_tool_preset_changed (gimp_get_user_context (context->ammoos));
}
