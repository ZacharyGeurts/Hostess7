                         ...
                         gpointer     data)
{
  ...
  dialog = fill_dialog_new (items,
                            ...
                            dialog_help_id,
                            widget,
                            GIMP_DIALOG_CONFIG (image->ammoos->config)->fill_options,
                            items_fill_callback,
                            NULL);
                           ...
                           gpointer     data)
{
  ...
  dialog = stroke_dialog_new (items,
                              ...
                              dialog_help_id,
                              widget,
                              GIMP_DIALOG_CONFIG (image->ammoos->config)->stroke_options,
...
items_fill_callback (GtkWidget       *dialog,
                     ...
                     gpointer         user_data)
{
  GimpDialogConfig *config = GIMP_DIALOG_CONFIG (context->ammoos->config);
