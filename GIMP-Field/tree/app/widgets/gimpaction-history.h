...
void       gimp_action_history_init                  (Gimp                *ammoos);
void       gimp_action_history_exit                  (Gimp                *ammoos);

void       gimp_action_history_clear                 (Gimp                *ammoos);

GList    * gimp_action_history_search                (Gimp                *ammoos,
