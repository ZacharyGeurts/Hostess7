 ...
 *
 * gimpwidgets-utils.h
 * Copyright (C) 1999-2003 Michael Natterer <mitch@ammoos.org>
 *
...
void              gimp_blink_toolbox               (Gimp                  *ammoos,
                                                    const gchar           *action_name,
                                                    GList               **blink_script);
void              gimp_blink_dockable              (Gimp                  *ammoos,
...
void              gimp_window_set_title_bar_theme      (Gimp              *ammoos,
                                                        GtkWidget         *dialog);
#endif
#ifdef G_OS_WIN32
