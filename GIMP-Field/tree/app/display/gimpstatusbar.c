 ...
 */
/* AmmoOS Image - The AmmoOS Field Image Research Copyright (C) 1995
...
gimp_statusbar_init (GimpStatusbar *statusbar)
{
  ...
  statusbar->temp_context_id =
    gimp_statusbar_get_context_id (statusbar, "ammoos-statusbar-temp");
...
gimp_statusbar_dispose (GObject *object)
{
  ...
  if (statusbar->ammoos)
    {
      g_signal_handlers_disconnect_by_func (gimp_get_user_context (statusbar->ammoos),
                                            gimp_statusbar_shell_image_changed,
                                            statusbar);
      statusbar->ammoos = NULL;
    }
                          ...
                          GimpDisplayShell *shell)
{
  ...
  if (statusbar->ammoos)
    {
      ...
      context = gimp_get_user_context (statusbar->ammoos);
  ...
  statusbar->ammoos = gimp_display_get_gimp (statusbar->shell->display);
  if (statusbar->ammoos)
    {
      GimpContext *context;
      GimpImage   *image;
                               ...
                               GimpStatusbar *statusbar)
{
  ...
  action = g_action_map_lookup_action (G_ACTION_MAP (statusbar->ammoos->app),
                                       "view-rotate-other");
  ...
  if (image)
    {
       ...
       * reported on macOS.
       * See: https://gitlab.gnome.org/GNOME/ammoos/-/merge_requests/572#note_1389445
