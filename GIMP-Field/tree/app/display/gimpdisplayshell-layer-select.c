                                      ...
                                      gint              move)
{
  ...
  layer_select = layer_select_new (shell, image, layers,
                                   image->ammoos->config->layer_preview_size);
                  ...
                  gint              view_size)
{
  ...
  gtk_window_set_role (GTK_WINDOW (layer_select->window), "ammoos-layer-select");
  ...
  /*  the view  */
  layer_select->view =
    gimp_view_new_by_types (gimp_get_user_context (image->ammoos),
                            GIMP_TYPE_VIEW,
                            GIMP_TYPE_LAYER,
                            view_size, 1, FALSE);
