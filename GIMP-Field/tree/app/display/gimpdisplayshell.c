...
gimp_display_shell_constructed (GObject *object)
{
  ...
  gimp_devices_add_widget (shell->display->ammoos, shell->hrule);
  gimp_devices_add_widget (shell->display->ammoos, shell->vrule);
  ...
  g_signal_connect_object (shell->display->ammoos->config,
                           "notify::theme",
  ...
  if (shell->paused_count == 1)
    {
      ...
      tool_manager_control_active (shell->display->ammoos,
