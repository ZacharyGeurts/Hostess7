 ...
 *
 * gimpcursorview.c
 * Copyright (C) 2005-2016 Michael Natterer <mitch@ammoos.org>
 *
...
gimp_cursor_view_constructed (GObject             *object)
{
  ...
  view->priv->color_frame_1 = gimp_color_frame_new (view->priv->ammoos);
  ...
  view->priv->color_frame_2 = gimp_color_frame_new (view->priv->ammoos);
                               ...
                               GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_GIMP:
      view->priv->ammoos = g_value_get_object (value);
      break;
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_GIMP:
      g_value_set_object (value, view->priv->ammoos);
      break;
  ...
  if (view->priv->context)
    {
      ...
      config  = context->ammoos->config->color_management;
...
GtkWidget *
gimp_cursor_view_new (Gimp            *ammoos,
