                                       ...
                                       GObjectConstructParam *params)
{
  ...
  g_assert (GIMP_IS_GIMP (options->ammoos));

  options->fill_options   = gimp_fill_options_new   (options->ammoos, NULL, FALSE);
  options->stroke_options = gimp_stroke_options_new (options->ammoos, NULL, FALSE);
                                        ...
                                        GParamSpec *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_GIMP:
      g_value_set_object (value, options->ammoos);
      break;
    case PROP_PATH:
                                        ...
                                        GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_GIMP:
      options->ammoos = g_value_get_object (value);
      break;
