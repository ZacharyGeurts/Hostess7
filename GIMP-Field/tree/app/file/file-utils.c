...
GFile *
file_utils_filename_to_file (Gimp         *ammoos,
                             ...
                             GError      **error)
{
  ...
  if (gimp_plug_in_manager_file_procedure_find_by_prefix (ammoos->plug_in_manager,
      ...
      if (uri && image_uri && ! strcmp (uri, image_uri))
        {
          ...
          imagefile = gimp_imagefile_new (image->ammoos, file);
