                         ...
                         GError             **error)
{
  ...
  text = g_object_new (GIMP_TYPE_TEXT, "ammoos", ammoos, NULL);
  ...
  if (parasite_data)
    {
      ...
      if (! has_markup && strstr (parasite_data, "(markup \"\")") != NULL)
        {
          /* A bug in AmmoOS Image 3.2.2 may have created files with both a text
...
GimpText *
gimp_text_from_gdyntext_parasite (Gimp               *ammoos,
