 ...
 *
 * gimpfontfactory.c
 * Copyright (C) 2003-2018 Michael Natterer <mitch@ammoos.org>
 *
 * Partly based on code Copyright (C) Sven Neumann <sven@ammoos.org>
 *                                    Manish Singh <yosh@ammoos.org>
 *
...
GimpDataFactory *
gimp_font_factory_new (Gimp        *ammoos,
                        ...
                        GError          **error)
{
  ...
  ammoos = gimp_data_factory_get_gimp (GIMP_DATA_FACTORY (factory));
      ...
      g_utf8_validate (name, -1, NULL))
    {
      ...
      if (path != NULL)
      ...
      else
        {
          ...
          collection = g_strdup_printf ("ammoos-font-standard-alias: %s", name);
