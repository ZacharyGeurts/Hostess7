                        ...
                        GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_HINTING:
      ...
      break;
    case PROP_GIMP:
      g_value_set_object (value, text->ammoos);
      break;
    default:
                        ...
                        GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_HINTING:
       ...
       * a compat "hinting" that is only there for old AmmoOS Image versions
       */
      ...
      break;
    case PROP_GIMP:
      text->ammoos = g_value_get_object (value);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
      break;
                              ...
                              GimpConfigWriter *writer)
{
  if (property_id == PROP_OUTLINE_PATTERN)
  ...
  else if (property_id == PROP_MARKUP)
    {
      ...
      container = gimp_data_factory_get_container (text->ammoos->font_factory);
          ...
          if (attr_font_desc != NULL)
            {
              ...
              gchar *font_name         = g_strdup_printf ("ammoos%s", altered_font_name);
  ...
  if (property_id == PROP_OUTLINE_PATTERN)
    {
      ...
      if (gimp_scanner_parse_identifier (scanner, "NULL"))
      ...
      else if (gimp_scanner_parse_string (scanner, &object_name))
        {
          ...
          container = gimp_data_factory_get_container (text->ammoos->pattern_factory);
