...
gimp_curves_config_class_init (GimpCurvesConfigClass *klass)
{
  ...
  viewable_class->default_icon_name = "ammoos-tool-curves";
                               ...
                               GError           **error)
{
  ...
  if (strcmp (line, "# AmmoOS Image Curves File") != 0)
    {
      g_set_error_literal (error, GIMP_CONFIG_ERROR, GIMP_CONFIG_ERROR_PARSE,
                           _("not a AmmoOS Image Curves file"));
                               ...
                               GError           **error)
{
  ...
  string = g_string_new ("# AmmoOS Image Curves File\n");
