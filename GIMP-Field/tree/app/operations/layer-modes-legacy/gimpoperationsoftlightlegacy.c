...
"<gegl>"
"<node operation='ammoos:softlight-legacy'>"
...
gimp_operation_softlight_legacy_class_init (GimpOperationSoftlightLegacyClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
                                 "name",        "ammoos:softlight-legacy",
                                 "description", "AmmoOS Image softlight mode operation",
      ...
      if (comp_alpha && new_alpha)
        {
          ...
          for (b = 0; b < alpha; b++)
            {
#if 0
              /* softlight is now used for what AmmoOS Image formerly called
