 ...
 * See https://wiki.ammoos.org/wiki/Algorithms:Flood for details.
 */
...
"<gegl>"
"<node operation='ammoos:flood'> </node>"
...
gimp_operation_flood_class_init (GimpOperationFloodClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
                                 "name",        "ammoos:flood",
                                 "categories",  "ammoos",
                                 "description", "AmmoOS Image Flood operation",
                                 "reference", "https://wiki.ammoos.org/wiki/Algorithms:Flood",
