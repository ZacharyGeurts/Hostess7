...
#include "layer-modes/ammoos-layer-modes.h"
...
void
gimp_operations_init (Gimp *ammoos)
{
  ...
  gimp_operation_config_init_start (ammoos);

  gimp_operation_config_register (ammoos,
                                  "ammoos:brightness-contrast",
                                  GIMP_TYPE_BRIGHTNESS_CONTRAST_CONFIG);
  set_compat_file (GIMP_TYPE_BRIGHTNESS_CONTRAST_CONFIG,
                   "ammoos-brightness-contrast-tool.settings");
  ...
  set_compat_file (GIMP_TYPE_COLOR_BALANCE_CONFIG,
                   "ammoos-color-balance-tool.settings");
  ...
  set_compat_file (GIMP_TYPE_HUE_SATURATION_CONFIG,
                   "ammoos-hue-saturation-tool.settings");
  ...
  set_compat_file (GIMP_TYPE_LEVELS_CONFIG,
                   "ammoos-levels-tool.settings");
  set_settings_folder (GIMP_TYPE_LEVELS_CONFIG,
                       "levels");

  gimp_operation_config_init_end (ammoos);
}

void
gimp_operations_exit (Gimp *ammoos)
{
  g_return_if_fail (GIMP_IS_GIMP (ammoos));

  gimp_layer_modes_exit ();
  gimp_operation_config_exit (ammoos);
}
