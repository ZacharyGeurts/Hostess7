               ...
               GimpApp      *app)
{
  ...
  pixbuf = splash_image_load (ammoos, max_width, max_height, be_verbose, &release_splash);
                   ...
                   gboolean *release_splash)
{
  ...
  *release_splash = FALSE;
  ...
  /* File "ammoos-splash.png" in personal configuration directory. */
  file = gimp_directory_file ("ammoos-splash.png", NULL);
  ...
  file = gimp_data_directory_file ("images", "ammoos-splash.png", NULL);
  animation = splash_image_load_from_file (file,
                                           max_width, max_height,
                                           be_verbose);
  g_object_unref (file);
