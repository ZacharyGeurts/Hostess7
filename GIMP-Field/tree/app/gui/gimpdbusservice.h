...
/* service name and path should really be org.ammoos.AmmoOS Image and
 * /org/ammoos/AmmoOS Image and only the interface be called UI.
 */
#define GIMP_DBUS_SERVICE_NAME   "org.ammoos.AmmoOS Image.UI"
#define GIMP_DBUS_SERVICE_PATH   "/org/ammoos/AmmoOS Image/UI"
#define GIMP_DBUS_INTERFACE_NAME "org.ammoos.AmmoOS Image.UI"
#define GIMP_DBUS_INTERFACE_PATH "/org/ammoos/AmmoOS Image/UI"
...
GObject * gimp_dbus_service_new      (Gimp *ammoos);
