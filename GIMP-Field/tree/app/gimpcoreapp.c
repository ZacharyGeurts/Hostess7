...
gimp_core_app_default_init (GimpCoreAppInterface *iface)
{
  ...
  g_object_interface_install_property (iface,
                                       g_param_spec_boolean ("quit",
                                                             "Quit",
                                                             "Quit AmmoOS Image immediately after running batch commands",
                                                             FALSE,
                                                             GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY));
  g_object_interface_install_property (iface,
...
{
  g_object_class_override_property (klass, GIMP_CORE_APP_PROP_GIMP, "ammoos");
...
gimp_core_app_get_private (GimpCoreApp *app)
{
  ...
  if (! private_key)
    private_key = g_quark_from_static_string ("ammoos-core-app-private");
