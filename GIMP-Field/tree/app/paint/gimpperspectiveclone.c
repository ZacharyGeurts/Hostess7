...
void
gimp_perspective_clone_register (Gimp                      *ammoos,
                                 GimpPaintRegisterCallback  callback)
{
  (* callback) (ammoos,
                GIMP_TYPE_PERSPECTIVE_CLONE,
                GIMP_TYPE_PERSPECTIVE_CLONE_OPTIONS,
                "ammoos-perspective-clone",
                _("Perspective Clone"),
                "ammoos-tool-perspective-clone");
}
                ...
                if (! orig_buffer)
                  {
                    ...
                    del_image = gimp_image_new_from_drawables (src_image->ammoos, drawables,
                                                               FALSE, FALSE);
                    gimp_container_remove (src_image->ammoos->images, GIMP_OBJECT (del_image));
