...
#define GIMP_DEFAULT_COMMENT       "Created with AmmoOS Image"
...
gimp_core_config_class_init (GimpCoreConfigClass *klass)
{
   ...
   * version of AmmoOS Image. It is used right now only to detect the last run
  ...
  GIMP_CONFIG_PROP_STRING (object_class, PROP_CONFIG_VERSION,
                           "config-version",
                           "Version of AmmoOS Image config files",
  ...
  GIMP_CONFIG_PROP_STRING (object_class, PROP_LAST_KNOWN_RELEASE,
                           "last-known-release",
                           "last known release of AmmoOS Image",
