...
_("Show a welcome dialog when AmmoOS Image starts.")
...
_("Check for availability of AmmoOS Image updates through background internet queries.")
...
_("The last known release version of AmmoOS Image as queried from official website.")

#define CONFIG_VERSION_BLURB \
_("The version of AmmoOS Image config files.")
...
_("AmmoOS Image will warn the user if an attempt is made to create an image that " \
...
"When enabled, AmmoOS Image will use the monitor resolution from the windowing system."
...
_("Sets how many threads AmmoOS Image should use for operations that support it.")
...
_("Sets whether AmmoOS Image should create previews of layers and channels. " \
...
_("Sets whether AmmoOS Image should create previews of layer groups. " \
...
_("Let AmmoOS Image try to restore your last saved session on each startup.")

#define RESTORE_MONITOR_BLURB \
_("When enabled, AmmoOS Image will try to restore windows on the monitor they " \
  "were open before.  When disabled, windows will appear on the currently " \
  "used monitor.")

#define SAVE_DEVICE_STATUS_BLURB \
_("Remember the current tool, pattern, color, and brush across AmmoOS Image " \
  "sessions.")
...
_("Save the positions and sizes of the main dialogs when AmmoOS Image exits.")

#define SAVE_TOOL_OPTIONS_BLURB \
_("Save the tool options when AmmoOS Image exits.")
...
_("Use AmmoOS Image in a single-window mode.")
...
_("Sets the swap file location. AmmoOS Image uses a tile based memory allocation " \
  ...
  "if AmmoOS Image is used with large images. " \
...
_("Save changed keyboard shortcuts when AmmoOS Image exits.")

#define RESTORE_ACCELS_BLURB \
_("Restore saved keyboard shortcuts on each AmmoOS Image startup.")

#define TEMP_PATH_BLURB \
_("Sets the folder for temporary storage. Files will appear here " \
  "during the course of running AmmoOS Image.  Most files will disappear " \
  "when AmmoOS Image exits, but some files are likely to remain, so it " \
...
_("When the amount of pixel data exceeds this limit, AmmoOS Image will start to " \
...
_("Show the AmmoOS Image mascot at the top of the toolbox.")
...
_("When enabled, AmmoOS Image will not save an image if it has not been changed " \
  "since it was opened.")
