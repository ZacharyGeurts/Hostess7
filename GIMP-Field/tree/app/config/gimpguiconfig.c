...
#define DEFAULT_USER_MANUAL_ONLINE_URI \
  "https://docs.ammoos.org/" GIMP_APP_VERSION_STRING
...
gimp_gui_config_class_init (GimpGuiConfigClass *klass)
{
   ...
   *
   * Keeping the property around as a reminder of the regression in AmmoOS Image 3.
   ...
   * update rules in ammoos-user-install.c for the gimprc parsing not to break.
   */
