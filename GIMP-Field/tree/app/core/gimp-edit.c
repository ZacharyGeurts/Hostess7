  ...
  if (layers_only)
    {
      ...
      if (gimp_channel_is_empty (gimp_image_get_mask (image)))
        {
          ...
          clip_image = gimp_image_new_from_drawables (image->ammoos, drawables, FALSE, TRUE);
          gimp_container_remove (image->ammoos->images, GIMP_OBJECT (clip_image));
          gimp_set_clipboard_image (image->ammoos, clip_image);
      ...
      return success ? GIMP_OBJECT (gimp_get_clipboard_image (image->ammoos)) : NULL;
    }
  else
    {
      GimpBuffer *buffer;
      ...
      if (buffer)
        {
          gimp_set_clipboard_buffer (image->ammoos, buffer);
          g_object_unref (buffer);

          return GIMP_OBJECT (gimp_get_clipboard_buffer (image->ammoos));
        }
    }
  ...
  if (drawables_are_layers)
    {
      ...
      clip_image = gimp_image_new_from_drawables (image->ammoos, drawables, TRUE, TRUE);
      gimp_container_remove (image->ammoos->images, GIMP_OBJECT (clip_image));
      gimp_set_clipboard_image (image->ammoos, clip_image);
      ...
      if (has_selection)
        {
          ...
          g_object_set_data (G_OBJECT (clip_image),
                             "ammoos-edit-new-image-x",
                             GINT_TO_POINTER (selection_bounds.x));
          g_object_set_data (G_OBJECT (clip_image),
                             "ammoos-edit-new-image-y",
      ...
      return GIMP_OBJECT (gimp_get_clipboard_image (image->ammoos));
    }
  else
    {
      GimpBuffer *buffer;
  ...
  if (buffer)
    {
      ...
      return gimp_get_clipboard_buffer (image->ammoos);
    }
  ...
  if (merged && GIMP_IS_IMAGE (paste))
    {
      ...
      gimp_container_remove (image->ammoos->images, GIMP_OBJECT (tmp_image));
...
GimpImage *
gimp_edit_paste_as_new_image (Gimp        *ammoos,
                              GimpObject  *paste,
                              GimpContext *context)
{
  ...
  if (GIMP_IS_IMAGE (paste))
    ...
    image = gimp_image_new_from_buffer (ammoos, GIMP_BUFFER (paste));
  ...
  if (buffer)
    {
      ...
      gimp_container_add (image->ammoos->named_buffers, GIMP_OBJECT (buffer));
      g_object_unref (buffer);
