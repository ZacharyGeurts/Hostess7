...
GimpTemplate *
gimp_image_new_get_last_template (Gimp      *ammoos,
                                  GimpImage *image)
{
  ...
  if (image)
    {
      ...
      gimp_config_sync (G_OBJECT (ammoos->config->default_image),
                        G_OBJECT (template), 0);
...
void
gimp_image_new_set_last_template (Gimp         *ammoos,
                                  GimpTemplate *template)
{
  g_return_if_fail (GIMP_IS_GIMP (ammoos));
  g_return_if_fail (GIMP_IS_TEMPLATE (template));

  gimp_set_last_template (ammoos, template);
}

GimpImage *
gimp_image_new_from_template (Gimp         *ammoos,
                              GimpTemplate *template,
                              GimpContext  *context)
{
  GimpImage               *image;
  ...
  image = gimp_create_image (ammoos,
...
GimpImage *
gimp_image_new_from_drawable (Gimp         *ammoos,
                              GimpDrawable *drawable)
{
  ...
  new_image = gimp_create_image (ammoos,
 ...
 * @tag_copies: tag copies of @drawable with "ammoos-image-copied-layer".
 * @copied_drawables:
 * @tagged_drawables:
 * @parent:
 * @new_parent:
...
GimpImage *
gimp_image_new_from_drawables (Gimp     *ammoos,
                               GList    *drawables,
...
GimpImage *
gimp_image_new_from_component (Gimp            *ammoos,
                               GimpImage       *image,
...
GimpImage *
gimp_image_new_from_buffer (Gimp       *ammoos,
                            GimpBuffer *buffer)
{
  GimpImage        *image;
  GimpLayer        *layer;
...
GimpImage *
gimp_image_new_from_pixbuf (Gimp        *ammoos,
                            GdkPixbuf   *pixbuf,
