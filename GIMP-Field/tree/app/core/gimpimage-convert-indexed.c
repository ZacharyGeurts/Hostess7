 ...
 * Copyright (C) 1997-2004 Adam D. Moss <adam@ammoos.org>
 *
 ...
 *  worse or better depending on what you enjoy...).  [adam@ammoos.org]
 *
 ...
 *  dither methods.  Makes positional dither much less lame.  [adam@ammoos.org]
 *
 ...
 *  partly what fs-dithering is for -- use it).  [adam@ammoos.org]
 *
