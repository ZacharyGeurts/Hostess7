...
gimp_link_class_init (GimpLinkClass *klass)
{
  ...
  link_props[PROP_GIMP]          = g_param_spec_object ("ammoos", NULL, NULL,
                                                        GIMP_TYPE_GIMP,
                        ...
                        GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_GIMP:
      g_value_set_object (value, link->p->ammoos);
      break;
    case PROP_FILE:
                        ...
                        GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_GIMP:
      link->p->ammoos = g_value_get_object (value);
      break;
    case PROP_FILE:
  ...
  if (link->p->file)
    {
      ...
      image = file_open_image (link->p->ammoos,
                               gimp_get_user_context (link->p->ammoos),
                               progress,
                               link->p->file,
