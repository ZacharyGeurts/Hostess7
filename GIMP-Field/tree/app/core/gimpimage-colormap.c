...
gimp_image_colormap_init (GimpImage *image)
{
  ...
  palette_id = g_strdup_printf ("ammoos-indexed-image-palette-%d",
                                gimp_image_get_id (image));
  ...
  palettes = gimp_data_factory_get_container (image->ammoos->palette_factory);
...
gimp_image_colormap_update_formats (GimpImage *image)
{
  ...
  format_name = g_strdup_printf ("-ammoos-indexed-format-%d",
                                 gimp_image_get_id (image));
