 ...
 */
GimpImage *
gimp_image_metadata_load_thumbnail (Gimp        *ammoos,
                                    GFile       *file,
  ...
  if (pixbuf)
    {
       ...
       * true with AmmoOS Image which always exports RGB thumbnails (see code in
      ...
      *format = gimp_pixbuf_get_format (pixbuf);
      ...
      gimp_image_apply_metadata_orientation (image, gimp_get_user_context (ammoos), metadata, NULL);
    }
