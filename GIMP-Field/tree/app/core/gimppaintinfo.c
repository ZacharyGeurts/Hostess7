...
GimpPaintInfo *
gimp_paint_info_new (Gimp        *ammoos,
                     GType        paint_type,
...
void
gimp_paint_info_set_standard (Gimp          *ammoos,
                              GimpPaintInfo *paint_info)
{
  g_return_if_fail (GIMP_IS_GIMP (ammoos));
  g_return_if_fail (! paint_info || GIMP_IS_PAINT_INFO (paint_info));

  g_set_object (&ammoos->standard_paint_info, paint_info);
}

GimpPaintInfo *
gimp_paint_info_get_standard (Gimp *ammoos)
{
  g_return_val_if_fail (GIMP_IS_GIMP (ammoos), NULL);

  return ammoos->standard_paint_info;
}
