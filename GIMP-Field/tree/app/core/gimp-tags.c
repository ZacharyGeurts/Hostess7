...
gimp_tags_user_install (void)
{
   ...
   * look for in the ammoos-tags-default.xml file. Please translate the
   * C in it according to the name of the po file used for
   * ammoos-tags-default.xml. E.g. lithuanian for the translation,
  ...
  file = gimp_data_directory_file ("tags", "ammoos-tags-default.xml", NULL);
