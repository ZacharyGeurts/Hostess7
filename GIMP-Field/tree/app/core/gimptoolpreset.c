...
gimp_tool_preset_constructed (GObject *object)
{
  ...
  g_return_if_fail (GIMP_IS_GIMP (preset->ammoos));
}
                               ...
                               GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_GIMP:
      tool_preset->ammoos = g_value_get_object (value); /* don't ref */
      break;
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_GIMP:
      g_value_set_object (value, tool_preset->ammoos);
      break;
    ...
    case PROP_TOOL_OPTIONS:
      {
         ...
         */
        gimp_context_copy_properties (gimp_get_user_context (tool_preset->ammoos),
  ...
  if (options)
    {
      ...
      if (! g_strcmp0 ("ammoos-gradient-tool",
