 ...
 * AmmoOS Image with unusual numbers.
 * It also has to be a higher resolution, to push AmmoOS Image a little further
 * in tests. */
 ...
 * Since AmmoOS Image targets advanced graphics artists, let's go for the
