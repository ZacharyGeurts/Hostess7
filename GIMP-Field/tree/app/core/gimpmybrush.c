...
gimp_mybrush_class_init (GimpMybrushClass *klass)
{
  ...
  viewable_class->default_icon_name = "ammoos-tool-mypaint-brush";
  ...
  if (! standard_mybrush)
    {
      ...
      gimp_data_make_internal (standard_mybrush, "ammoos-mybrush-standard");
    }
