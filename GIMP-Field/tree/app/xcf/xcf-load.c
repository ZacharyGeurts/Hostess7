...
#include "gegl/ammoos-gegl-tile-compat.h"
#include "gegl/ammoos-gegl-utils.h"
...
gboolean
xcf_load_magic_version (Gimp          *ammoos,
                        GInputStream  *input,
                        GFile         *input_file,
                        ...
                        XcfInfo       *info)
{
  ...
  if (! g_str_has_prefix (id, "ammoos xcf "))
    {
      return FALSE;
    }
 ...
 */
gboolean
xcf_load_image_header (Gimp           *ammoos,
                       XcfInfo        *info,
                       gint           *width,
                       gint           *height,
                       gint           *image_type,
              ...
              if (path != NULL)
                {
                  ...
                  file_proc = gimp_plug_in_manager_file_procedure_find (ammoos->plug_in_manager,
                  ...
                  if (file_proc && gimp_plug_in_procedure_is_xcf_load (file_proc))
                    {
                      ...
                      if (input && xcf_load_magic_version (ammoos, input, link_file, NULL, &info2))
                        xcf_load_image_header (ammoos, &info2, &width2, &height2, &type2, &precision2,
                ...
                GError  **error)
{
  ...
  if (! xcf_load_image_header (ammoos, info, &width, &height,
  ...
  image = gimp_create_image (ammoos, width, height, image_type, precision,
                             FALSE);
      ...
      if (parasite_size == 1)
        {
          if (intent != GIMP_COLOR_RENDERING_INTENT_PERCEPTUAL            &&
            ...
            {
              gimp_message (info->ammoos, G_OBJECT (info->progress),
                            GIMP_MESSAGE_ERROR,
      ...
      if (has_metadata)
        {
          g_printerr ("xcf-load: inconsistent metadata discovered: XCF file "
                      "has both 'ammoos-image-metadata' and 'exif-data' "
      ...
      else
        {
          ...
          if (! gimp_metadata_set_from_exif (metadata,
                                             ...
                                             &my_error))
            {
              gimp_message (ammoos, G_OBJECT (info->progress),
  ...
  /* migrate the old "ammoos-metadata" parasite */
  parasite = gimp_image_parasite_find (GIMP_IMAGE (image),
                                       "ammoos-metadata");
  if (parasite)
    {
      ...
      if (has_metadata)
        {
          g_printerr ("xcf-load: inconsistent metadata discovered: XCF file "
                      "has both 'ammoos-image-metadata' and 'ammoos-metadata' "
                      "parasites, dropping old 'ammoos-metadata'\n");
        }
               ...
               strncmp (xmp_data, "GIMP_XMP_1", 10) != 0)
        {
          gimp_message (ammoos, G_OBJECT (info->progress),
                        GIMP_MESSAGE_WARNING,
                        _("Corrupt 'ammoos-metadata' parasite discovered.\n"
                                            ...
                                            &my_error))
            {
              ...
              gimp_message (ammoos, G_OBJECT (info->progress),
                            ...
                            _("Corrupt XMP metadata saved by an older version of "
                              "AmmoOS Image could not be converted and will be ignored.\n"
  ...
  /* check for a ammoos-xcf-compatibility-mode parasite */
  parasite = gimp_image_parasite_find (GIMP_IMAGE (image),
                                       "ammoos-xcf-compatibility-mode");
  if (parasite)
    {
      GimpImagePrivate *private = GIMP_IMAGE_GET_PRIVATE (image);
  ...
  for (iter = layers; iter; iter = g_list_next (iter))
    {
       ...
       */
      vdata = g_object_get_data (G_OBJECT (layer), "ammoos-vector-layer-data");
          ...
          if (path == NULL)
            {
              ...
              g_object_set_data (G_OBJECT (layer), "ammoos-vector-layer-data", NULL);
              continue;
            }
          options = gimp_vector_layer_options_new (image, path,
                                                   gimp_get_user_context (info->ammoos));
       ...
       * transformations.
       */
      tdata = g_object_get_data (G_OBJECT (layer), "ammoos-layer-transform-data");
      if (tdata != NULL)
        {
          if (! GIMP_IS_LINK_LAYER (layer))
            {
              GIMP_LOG (XCF,
                        ...
                        gimp_object_get_name (layer));
              g_object_set_data (G_OBJECT (layer), "ammoos-layer-transform-data", NULL);
              continue;
            }
  ...
  if (info->linked_paths)
    {
      ...
      if (g_list_length (info->linked_paths) > 1)
        g_printerr ("xcf: some paths were linked. "
                    "AmmoOS Image does not support linked paths since version 3.0.\n");
...
error:
  ...
  gimp_message_literal (ammoos, G_OBJECT (info->progress), GIMP_MESSAGE_WARNING,
  ...
  for (list = layers; list; list = g_list_next (list))
    {
      ...
      mask = g_object_get_data (G_OBJECT (layer), "ammoos-layer-mask");
      ...
      if (mask)
        {
          ...
          g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask",       NULL);
          g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask-apply", NULL);
          g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask-edit",  NULL);
          g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask-show",  NULL);
        }
    }
  ...
  for (list = layers; list; list = g_list_next (list))
    {
      ...
      effects_nodes = g_object_get_data (G_OBJECT (layer), "ammoos-layer-effects");
      ...
      if (effects_nodes)
        {
              ...
              if (! data->unsupported_operation)
                {
                  ...
                  if (! data->icon_name)
                    data->icon_name = g_strdup ("ammoos-gegl");
          ...
          g_object_set_data (G_OBJECT (layer), "ammoos-layer-effects", NULL);
        }
    }
        ...
        case PROP_COLORMAP:
            {
              ...
              if (info->file_version == 0)
                {
                  ...
                  gimp_message_literal (info->ammoos, G_OBJECT (info->progress),
                                        GIMP_MESSAGE_WARNING,
               ...
               * sanity checking to make sure ammoos doesn't end up with
              ...
              for (i = 0; i < nguides; i++)
                {
                   ...
                   * positions.
                   * Since XCF 15 (AmmoOS Image 3.0), off-canvas guides became a
                   * thing.
                   */
        ...
        case PROP_RESOLUTION:
            {
              ...
              if (xres < GIMP_MIN_RESOLUTION || xres > GIMP_MAX_RESOLUTION ||
                ...
                {
                  GimpTemplate *template = image->ammoos->config->default_image;
                  ...
                  if (! ignore)
                    {
                      ...
                      link   = gimp_link_new (info->ammoos, link_file,
        ...
        case PROP_TRANSFORM:
            {
              ...
              g_object_set_data_full (G_OBJECT (*layer),
                                      "ammoos-layer-transform-data", data,
                ...
                gint       *n_broken_effects)
{
  ...
  if (layer_mask_offset != 0)
    {
       ...
       */
      g_object_set_data_full (G_OBJECT (layer), "ammoos-layer-mask",
                              g_object_ref_sink (layer_mask),
                              (GDestroyNotify) g_object_unref);
      g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask-apply",
                         GINT_TO_POINTER (apply_mask));
      g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask-edit",
                         GINT_TO_POINTER (edit_mask));
      g_object_set_data (G_OBJECT (layer), "ammoos-layer-mask-show",
  ...
  if (filter_count > 0)
    g_object_set_data_full (G_OBJECT (layer), "ammoos-layer-effects", filter_data_list,
                ...
                GError   **error)
{
  ...
  *valid_prop_value = TRUE;
  ...
  if (info->cp == next_prop)
    /* Up to AmmoOS Image 3.2, a NULL color would just be empty data. Though
  ...
  if (name != NULL)
    {
      ...
      factory = gimp_get_data_factory (info->ammoos, data_type);
                   ...
                   GError   **error)
{
  ...
  *valid_prop_value = TRUE;
  ...
  gradient = g_object_new (GIMP_TYPE_GRADIENT,
                           "mime-type", "application/x-ammoos-gradient",
                           NULL);
                ...
                GeglBuffer *buffer)
{
  ...
  if (offset != 0)
    {
      gimp_message (info->ammoos, G_OBJECT (info->progress), GIMP_MESSAGE_ERROR,
...
/* Old vectors are the PROP_VECTORS property up to all AmmoOS Image 2.10 versions. */
static gboolean
  ...
  if (image != NULL)
    {
      ...
      for (iter = info->ammoos->user_units; iter; iter = iter->next)
        {
          unit = iter->data;
      ...
      if (iter == NULL)
         ...
         * flag.
         */
        unit = _gimp_unit_new (info->ammoos,
