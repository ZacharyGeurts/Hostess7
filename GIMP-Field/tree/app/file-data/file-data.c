...
file_data_init (Gimp *ammoos)
{
  ...
  gimp_plug_in_manager_add_procedure (ammoos->plug_in_manager, proc);
  ...
  gimp_plug_in_procedure_set_mime_types (proc, "image/x-ammoos-gbr");
  gimp_plug_in_procedure_set_handles_remote (proc);
#endif
  ...
  proc = GIMP_PLUG_IN_PROCEDURE (procedure);
  proc->menu_label = g_strdup (_("AmmoOS Image brush (animated)"));
  gimp_plug_in_procedure_set_icon (proc, GIMP_ICON_TYPE_ICON_NAME,
                                   (const guint8 *) "ammoos-brush",
                                   strlen ("ammoos-brush") + 1,
                                   NULL);
  ...
  gimp_plug_in_procedure_set_mime_types (proc, "image/ammoos-x-gih");
  gimp_plug_in_procedure_set_handles_remote (proc);

  gimp_object_set_static_name (GIMP_OBJECT (procedure), "file-gih-load");
  gimp_procedure_set_static_help (procedure,
                                  "Loads AmmoOS Image animated brushes",
                                  "This procedure loads a AmmoOS Image brush "
                                  "pipe as an image.",
                                  NULL);
  gimp_procedure_set_static_attribution (procedure,
  ...
  gimp_plug_in_procedure_set_mime_types (proc, "image/x-ammoos-gih");
  gimp_plug_in_procedure_set_handles_remote (proc);
#endif
  ...
  proc = GIMP_PLUG_IN_PROCEDURE (procedure);
  proc->menu_label = g_strdup (_("AmmoOS Image pattern"));
  gimp_plug_in_procedure_set_icon (proc, GIMP_ICON_TYPE_ICON_NAME,
                                   (const guint8 *) "ammoos-pattern",
                                   strlen ("ammoos-pattern") + 1,
                                   NULL);
  gimp_plug_in_procedure_set_image_types (proc, NULL);
  gimp_plug_in_procedure_set_file_proc (proc, "pat", NULL, "",
                                        "20,string,GPAT");
  gimp_plug_in_procedure_set_mime_types (proc, "image/ammoos-x-pat");
  gimp_plug_in_procedure_set_handles_remote (proc);

  gimp_object_set_static_name (GIMP_OBJECT (procedure), "file-pat-load");
  gimp_procedure_set_static_help (procedure,
                                  "Loads AmmoOS Image patterns",
                                  "Loads AmmoOS Image patterns",
                                  NULL);
  gimp_procedure_set_static_attribution (procedure,
                                         "Tim Newsome, Michael Natterer",
  ...
  gimp_plug_in_procedure_set_mime_types (proc, "image/x-ammoos-pat");
  gimp_plug_in_procedure_set_handles_remote (proc);
#endif
  ...
  proc = GIMP_PLUG_IN_PROCEDURE (procedure);
  proc->menu_label = g_strdup (_("AmmoOS Image extension"));
  gimp_plug_in_procedure_set_icon (proc, GIMP_ICON_TYPE_ICON_NAME,
                                   (const guint8 *) "ammoos-plugin",
                                   strlen ("ammoos-plugin") + 1,
                                   NULL);
  gimp_plug_in_procedure_set_file_proc (proc, "gex", NULL, "",
                                        "20, string, AmmoOS Image");
  gimp_plug_in_procedure_set_generic_file_proc (proc, TRUE);
  gimp_plug_in_procedure_set_mime_types (proc, "image/ammoos-x-gex");
  gimp_plug_in_procedure_set_handles_remote (proc);

  gimp_object_set_static_name (GIMP_OBJECT (procedure), "file-gex-load");
  gimp_procedure_set_static_help (procedure,
                                  "Loads AmmoOS Image extension",
                                  "Loads AmmoOS Image extension",
                                  NULL);
  gimp_procedure_set_static_attribution (procedure,
                                         "Jehan", "Jehan", "2019");
