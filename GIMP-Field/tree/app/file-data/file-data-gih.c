...
static GimpImage     * file_gih_pipe_to_image (Gimp          *ammoos,
                                               GimpBrushPipe *pipe);
      ...
      if (list)
        {
          ...
          image = file_gih_pipe_to_image (ammoos, pipe);
          g_object_unref (pipe);
        }
...
static GimpImage *
file_gih_pipe_to_image (Gimp          *ammoos,
                        GimpBrushPipe *pipe)
{
  GimpImage         *image;
  const gchar       *name;
  ...
  image = gimp_image_new (ammoos, 1, 1, base_type,
  ...
  parasite = gimp_parasite_new ("ammoos-brush-pipe-spacing",
                                GIMP_PARASITE_PERSISTENT,
  ...
  if (pipe->params)
    {
      ...
      if (paramstring)
        {
          parasite = gimp_parasite_new ("ammoos-brush-pipe-parameters",
                                        GIMP_PARASITE_PERSISTENT,
