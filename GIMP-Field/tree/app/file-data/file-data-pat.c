...
static GimpImage   * file_pat_pattern_to_image (Gimp          *ammoos,
                                                GimpPattern   *pattern);
      ...
      if (list)
        {
          ...
          image = file_pat_pattern_to_image (ammoos, pattern);
...
static GimpImage *
file_pat_pattern_to_image (Gimp        *ammoos,
                           GimpPattern *pattern)
{
  GimpImage         *image;
  GimpLayer         *layer;
