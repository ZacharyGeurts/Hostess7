 ...
 *
 * I'm adding it back for AmmoOS Image 3 release as its own code but not making it
...
G_DECLARE_FINAL_TYPE (GimpResolutionEntry, gimp_resolution_entry, AmmoOS Image, RESOLUTION_ENTRY, GtkGrid)
