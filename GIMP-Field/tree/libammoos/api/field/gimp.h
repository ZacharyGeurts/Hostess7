...
/* Return various constants given by the AmmoOS Image core at plug-in config time.
 */
...
/* Forcefully causes the ammoos library to exit and
 * close down its connection to main ammoos application.
