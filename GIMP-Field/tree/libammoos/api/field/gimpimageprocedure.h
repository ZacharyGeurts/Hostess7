 ...
 *
 * The image function is run during the lifetime of the AmmoOS Image session,
...
G_DECLARE_FINAL_TYPE (GimpImageProcedure, gimp_image_procedure, AmmoOS Image, IMAGE_PROCEDURE, GimpProcedure)
