...
GIMP_DEPRECATED_FOR(ammoos:brightness_contrast)
gboolean gimp_drawable_brightness_contrast (GimpDrawable         *drawable,
                                            gdouble               brightness,
                                            gdouble               contrast);
GIMP_DEPRECATED_FOR(ammoos:color_balance)
gboolean gimp_drawable_color_balance       (GimpDrawable         *drawable,
                                            ...
                                            gdouble               yellow_blue);
GIMP_DEPRECATED_FOR(ammoos:colorize)
gboolean gimp_drawable_colorize_hsl        (GimpDrawable         *drawable,
                                            gdouble               hue,
                                            gdouble               saturation,
                                            gdouble               lightness);
GIMP_DEPRECATED_FOR(ammoos:curves)
...
gboolean gimp_drawable_extract_component   (GimpDrawable         *drawable,
                                            ...
                                            gboolean              invert,
                                            gboolean              linear);
GIMP_DEPRECATED_FOR(ammoos:desaturate)
...
gboolean gimp_drawable_histogram           (GimpDrawable         *drawable,
                                            ...
                                            gdouble              *count,
                                            gdouble              *percentile);
GIMP_DEPRECATED_FOR(ammoos:hue_saturation)
...
gboolean gimp_drawable_invert              (GimpDrawable         *drawable,
                                            gboolean              linear);
GIMP_DEPRECATED_FOR(ammoos:levels)
...
GIMP_DEPRECATED_FOR(ammoos:posterize)
gboolean gimp_drawable_posterize           (GimpDrawable         *drawable,
                                            gint                  levels);
GIMP_DEPRECATED_FOR(ammoos:threshold)
