 ...
 *
 * The batch function is run during the lifetime of the AmmoOS Image session,
...
G_DECLARE_FINAL_TYPE (GimpBatchProcedure, gimp_batch_procedure, AmmoOS Image, BATCH_PROCEDURE, GimpProcedure)
