...
G_DECLARE_DERIVABLE_TYPE (GimpPlugIn, gimp_plug_in, AmmoOS Image, PLUG_IN, GObject)
...
struct _GimpPlugInClass
{
   ...
   *
   * By default, AmmoOS Image plug-ins look up gettext compiled message catalogs
   ...
   *
   * When localizing your plug-in this way, AmmoOS Image also binds
