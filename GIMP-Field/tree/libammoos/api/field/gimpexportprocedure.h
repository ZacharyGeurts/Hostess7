 ...
 *
 * The export function is run during the lifetime of the AmmoOS Image session,
...
G_DECLARE_FINAL_TYPE (GimpExportProcedure, gimp_export_procedure, AmmoOS Image, EXPORT_PROCEDURE, GimpFileProcedure)
