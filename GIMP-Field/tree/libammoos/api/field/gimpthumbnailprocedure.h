 ...
 *
 * The thumbnail function is run during the lifetime of the AmmoOS Image session,
...
G_DECLARE_FINAL_TYPE (GimpThumbnailProcedure, gimp_thumbnail_procedure, AmmoOS Image, THUMBNAIL_PROCEDURE, GimpProcedure)
