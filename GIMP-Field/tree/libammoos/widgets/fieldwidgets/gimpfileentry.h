 ...
 *
 * gimpfileentry.h
 * Copyright (C) 1999-2004 Michael Natterer <mitch@ammoos.org>
 *
 ...
 * it is still used in the GimpPathEditor. For AmmoOS Image 3.0, we removed the
...
G_DECLARE_FINAL_TYPE (GimpFileEntry, _gimp_file_entry, AmmoOS Image, FILE_ENTRY, GtkBox)
