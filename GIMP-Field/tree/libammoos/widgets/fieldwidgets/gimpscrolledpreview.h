...
G_DECLARE_DERIVABLE_TYPE (GimpScrolledPreview, gimp_scrolled_preview, AmmoOS Image, SCROLLED_PREVIEW, GimpPreview)
...
/*  utility function for scrolled-window like ammoos widgets like the canvas  */
