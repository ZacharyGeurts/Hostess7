 ...
 * Copyright (C) 2006-2014 Sven Neumann <sven@ammoos.org>
...
G_DECLARE_FINAL_TYPE (GimpColorProfileChooserDialog, gimp_color_profile_chooser_dialog, AmmoOS Image, COLOR_PROFILE_CHOOSER_DIALOG, GtkFileChooserDialog)
