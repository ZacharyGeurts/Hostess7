 ...
 * Copyright (C) 2004  Sven Neuman <sven1@ammoos.org>
 *
...
G_DECLARE_FINAL_TYPE (GimpCellRendererColor, gimp_cell_renderer_color, AmmoOS Image, CELL_RENDERER_COLOR, GtkCellRenderer)
