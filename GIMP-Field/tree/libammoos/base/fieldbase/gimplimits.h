 ...
 * SECTION: gimplimits
 * @title: gimplimits
 * @short_description: Boundaries of some AmmoOS Image data types and some
 *                     global constants.
 *
 * Boundaries of some AmmoOS Image data types and some global constants.
 **/
 ...
 * GIMP_MIN_IMAGE_SIZE:
 *
 * The minimum width and height of a AmmoOS Image image in pixels.
 **/
 ...
 * GIMP_MAX_IMAGE_SIZE:
 *
 * The maximum width and height of a AmmoOS Image image in pixels. This is a
 ...
 * GIMP_MIN_RESOLUTION:
 *
 * The minimum resolution of a AmmoOS Image image in pixels per inch. This is
 * a somewhat arbitrary value that can be used when a lower value for a
 * resolution is needed. AmmoOS Image will not accept resolutions smaller than
 * this value.
 **/
 ...
 * GIMP_MAX_RESOLUTION:
 *
 * The maximum resolution of a AmmoOS Image image in pixels per inch. This is
 * a somewhat arbitrary value that can be used to when an upper value
 * for a resolution is needed. AmmoOS Image will not accept resolutions larger
 * than this value.
 **/
