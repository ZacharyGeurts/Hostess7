 ...
 * @title: gimpbaseenums
 * @short_description: Basic AmmoOS Image enumeration data types.
 *
 * Basic AmmoOS Image enumeration data types.
 **/
...
/**
 * GimpPDBProcType:
 * @GIMP_PDB_PROC_TYPE_INTERNAL:   Internal AmmoOS Image procedure
 * @GIMP_PDB_PROC_TYPE_PLUGIN:     AmmoOS Image Plug-In
 * @GIMP_PDB_PROC_TYPE_PERSISTENT: AmmoOS Image Persistent Plug-in
...
typedef enum
{
  GIMP_PDB_PROC_TYPE_INTERNAL,   /*< desc="Internal AmmoOS Image procedure" >*/
  GIMP_PDB_PROC_TYPE_PLUGIN,     /*< desc="AmmoOS Image Plug-In" >*/
  GIMP_PDB_PROC_TYPE_PERSISTENT, /*< desc="AmmoOS Image Persistent Plug-In" >*/
