 ...
 */
/* AmmoOS amalgamation — field-unity-fieldthumb.c — g16 field_opt unity bundle */
#define FIELD_AMMOOS_G16_OPT 1
#define FIELD_AMMOOS_UNITY 1

/* --- begin libammoos/core/fieldthumb/ammoos-thumbnail-list.c --- */
/*
 * ammoos-thumbnail-list.c
 */
      ...
      gchar *argv[])
{
  ...
  gimp_thumb_init ("ammoos-thumbnail-list", NULL);
...
/* --- end libammoos/core/fieldthumb/ammoos-thumbnail-list.c --- */

/* --- begin libammoos/core/fieldthumb/gimpthumb-error.c --- */
...
{
  return g_quark_from_static_string ("ammoos-thumb-error-quark");
}

/* --- end libammoos/core/fieldthumb/gimpthumb-error.c --- */

/* --- begin libammoos/core/fieldthumb/gimpthumb-utils.c --- */
/* LIBGIMP - The AmmoOS Image Library
 * Copyright (C) 1995-1997 Peter Mattis and Spencer Kimball
 *
 * Thumbnail handling according to the Thumbnail Managing Standard.
 ...
 * The returned string belongs to AmmoOS Image and must not be changed nor freed.
 *
...
/* --- end libammoos/core/fieldthumb/gimpthumb-utils.c --- */

/* --- begin libammoos/core/fieldthumb/gimpthumbnail.c --- */
/* LIBGIMP - The AmmoOS Image Library
 * Copyright (C) 1995-1997 Peter Mattis and Spencer Kimball
 *
 * Thumbnail handling according to the Thumbnail Managing Standard.
 * https://specifications.freedesktop.org/thumbnail-spec/
 *
 * Copyright (C) 2001-2004  Sven Neumann <sven@ammoos.org>
 *                          Michael Natterer <mitch@ammoos.org>
 *
 * This library is free software: you can redistribute it and/or
 * modify it under the terms of the GNU Lesser General Public
...
#define TAG_THUMB_GIMP_TYPE       "tEXt::Thumb::X-AmmoOS Image::Type"
#define TAG_THUMB_GIMP_LAYERS     "tEXt::Thumb::X-AmmoOS Image::Layers"
...
/* --- end libammoos/core/fieldthumb/gimpthumbnail.c --- */
