 ...
 *
 * The signature of the query function a loadable AmmoOS Image module must
 ...
 * @module:  The module responsible for this loadable module.
 *
 * The signature of the register function a loadable AmmoOS Image module must
...
G_DECLARE_DERIVABLE_TYPE (GimpModule, gimp_module, AmmoOS Image, MODULE, GTypeModule)
