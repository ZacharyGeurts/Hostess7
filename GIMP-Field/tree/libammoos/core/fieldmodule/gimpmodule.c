 ...
 * AmmoOS Image. It is a #GTypeModule subclass, implementing module loading
 ...
 *
 * Returns: the #GQuark that defines the AmmoOS Image module error domain.
 *
 * Since: 2.8
 **/
GQuark
...
{
  return g_quark_from_static_string ("ammoos-module-error-quark");
}
