 ...
 * Copyright (C) 2002-2003 Michael Natterer <mitch@ammoos.org>,
...
static const GimpModuleInfo cdisplay_colorblind_info =
{
  ...
  "Michael Natterer <mitch@ammoos.org>, Bob Dougherty <bob@vischeck.com>, "
  "Alex Wade <alex@vischeck.com>",
  "v0.2",
...
cdisplay_colorblind_class_init (CdisplayColorblindClass *klass)
{
  ...
  display_class->help_id         = "ammoos-colordisplay-colorblind";
