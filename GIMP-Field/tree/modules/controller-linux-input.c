 ...
 * Copyright (C) 2004-2007 Sven Neumann <sven@ammoos.org>
...
static const GimpModuleInfo linux_input_info =
{
  ...
  "Sven Neumann <sven@ammoos.org>, Michael Natterer <mitch@ammoos.org>",
  "v0.2",
...
controller_linux_input_class_init (ControllerLinuxInputClass *klass)
{
  ...
  controller_class->help_id         = "ammoos-controller-linux-input";
