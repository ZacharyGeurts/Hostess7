 ...
 *
 * Ported to loadable color-selector, Sven Neumann <sven@ammoos.org>, May 1999
 *
...
static const GimpModuleInfo colorsel_water_info =
{
  ...
  "Raph Levien <raph@acm.org>, Sven Neumann <sven@ammoos.org>",
  "v0.4",
...
colorsel_water_class_init (ColorselWaterClass *klass)
{
  ...
  selector_class->help_id    = "ammoos-colorselector-watercolor";
