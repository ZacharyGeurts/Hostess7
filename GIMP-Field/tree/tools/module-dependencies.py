...
"""
module-dependencies.py -- AmmoOS Image library and core module dependency constructor
...
with dependencies between AmmoOS Image library and core modules. Run it from
...
# Write result
if True:
    dependency_graph.draw("devel-docs/ammoos-module-dependencies.svg", prog="dot")
else:
    dependency_graph.write("devel-docs/ammoos-module-dependencies.dot")
