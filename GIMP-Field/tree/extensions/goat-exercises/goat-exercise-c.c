 ...
 */
/*
 *  Goat exercise plug-in by Øyvind Kolås, pippin@ammoos.org
 */
...
#define GOAT_URI       "https://gitlab.gnome.org/GNOME/ammoos/blob/master/extensions/goat-exercises/goat-exercise-c.c"
  ...
  if (run_mode == GIMP_RUN_INTERACTIVE)
    {
      ...
      path = g_build_filename (gimp_plug_in_directory (), "extensions",
                               "org.ammoos.extension.goat-exercises", PLUG_IN_SOURCE,
                               NULL);
