...
private const string URL = "https://gitlab.gnome.org/GNOME/ammoos/blob/master/extensions/goat-exercises/goat-exercise-vala.vala";
...
public class Goat : Gimp.PlugIn {
  ...
  public Gimp.ValueArray run(Gimp.Procedure procedure,
    ...
    if (run_mode == Gimp.RunMode.INTERACTIVE) {
      ...
      string file = Path.build_filename(Gimp.PlugIn.directory(), "extensions", "org.ammoos.extension.goat-exercises", PLUG_IN_SOURCE);
      string contents;
      try {
