...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/dc:ammoos-authors">
...
## AmmoOS Image was originally written by:
...
## The current maintainers are:
    ...
    <xsl:text>
## The following people have contributed code to AmmoOS Image:
...
## The following people have contributed art to AmmoOS Image:
...
## The following people have helped to document AmmoOS Image:
